...
import { DBZ_BOARD } from "./boards/dbz";
...
export const PACKS: Pack[] = [
  ...
  // ── Game of Thrones ───────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Brienne of Tarth", t: 4, f: 5, variants: [{ v: "with Oathkeeper in both hands", g: "major" }, { v: "sworn to a vow that says do not kill this man", g: "weakening" }, { v: "still looking for a Stark girl who does not want finding", g: "crippling" }] },
      { n: "Jon Snow", t: 4, f: 5, variants: [{ v: "resurrected", g: "boon" }, { v: "Lord Commander", g: "neutral" }, { v: "green recruit", g: "crippling" }, { v: "given a horse, a sword and no plan whatsoever", g: "weakening" }] },
      { n: "Daenerys Targaryen", t: 3, f: 5, variants: [{ v: "with three dragons", t: 5 }, { v: "with one dragon", t: 4 }, { v: "alone in the Dothraki Sea", t: 1 }] },
      { n: "Tyrion Lannister", t: 2, f: 5, variants: [{ v: "Hand of the King", t: 3 }, { v: "on trial, in chains", t: 1 }, { v: "drunk, and he knows things", g: "boon" }] },
      { n: "Khal Drogo", t: 5, f: 5, variants: [{ v: "prime", g: "boon" }, { v: "infected wound", g: "crippling" }] },
      { n: "Oberyn Martell", t: 5, s: "Red Viper", variants: [{ v: "with the poisoned spear, circling", g: "major" }, { v: "gloating instead of finishing him", g: "crippling" }, { v: "sober, for once", g: "neutral" }] },
      { n: "Bronn", t: 4, variants: [{ v: "paid up front, in coin", g: "boon" }, { v: "offered a better contract by the other side", g: "crippling" }, { v: "still waiting on the castle he was promised", g: "weakening" }] },
      { n: "Ser Barristan Selmy", t: 4, variants: [{ v: "prime, Barristan the Bold", t: 5 }, { v: "old man", t: 3 }] },
      { n: "Night King", t: 5, f: 5, s: "Game of Thrones", variants: [{ v: "with the army of the dead behind him", g: "legendary" }, { v: "walking alone into a courtyard full of children", g: "weakening" }, { v: "a very small girl has got behind him", g: "crippling" }] },
      { n: "Cersei Lannister", t: 2, f: 5, variants: [{ v: "a cup of wine and the Mountain at her shoulder", g: "major" }, { v: "the walk of atonement", g: "crippling" }, { v: "pregnant, allegedly", g: "neutral" }] },
      { n: "Ramsay Bolton", t: 3, variants: [{ v: "hounds starved for a week and a bow", g: "major" }, { v: "hands tied to a chair in his own kennels", g: "crippling" }] },
      { n: "Grey Worm", t: 4, variants: [{ v: "Unsullied discipline, spear and shield locked", g: "boon" }, { v: "distracted, thinking about Missandei", g: "weakening" }] },
      { n: "Syrio Forel", t: 4, variants: [{ v: "given a real sword for once", g: "major" }, { v: "with a wooden practice stick", g: "crippling" }, { v: "not today", g: "neutral" }] },
      { n: "Ygritte", t: 3, variants: [{ v: "on top of the Wall with a full quiver", g: "boon" }, { v: "you know nothing", g: "neutral" }, { v: "shot in the back mid-sentence", g: "crippling" }] },
      { n: "Tormund Giantsbane", t: 4, variants: [{ v: "full of sour goat milk", g: "boon" }, { v: "staring at Brienne", g: "crippling" }] },
      { n: "Melisandre", t: 3, variants: [{ v: "with her ruby", t: 4 }, { v: "without her necklace", t: 1 }, { v: "a leech and a king's blood", g: "major" }] },
      { n: "Podrick Payne", t: 2, f: 1, variants: [{ v: "inexplicably excellent at exactly one thing", g: "boon" }, { v: "left holding the horses", g: "crippling" }] },
      { n: "Samwell Tarly", t: 1, f: 5, variants: [{ v: "dragonglass and a lucky angle", g: "boon" }, { v: "reciting something he read in a book", g: "neutral" }, { v: "handed a sword and asked to use it", g: "crippling" }] },
      { n: "Hodor", t: 3, variants: [{ v: "holding the door", g: "legendary" }, { v: "Hodor", g: "neutral" }, { v: "Wylis, before the seizure", g: "weakening" }] },
      { n: "Euron Greyjoy", t: 4, variants: [{ v: "the Iron Fleet at his back", g: "major" }, { v: "ashore, on dry land, with no ship at all", g: "crippling" }, { v: "promising a gift he cannot actually deliver", g: "weakening" }] },
      { n: "Beric Dondarrion", t: 4, s: "flaming sword", variants: [{ v: "the flaming sword lit", g: "major" }, { v: "out of resurrections", g: "crippling" }, { v: "Thoros is dead and nobody else can say the words", g: "weakening" }] },
      { n: "Robb Stark", t: 4, s: "Young Wolf", variants: [{ v: "undefeated in the field", g: "major" }, { v: "having married for love", g: "weakening" }, { v: "at a wedding, unarmoured", g: "crippling" }] },
      { n: "Littlefinger", t: 1, s: "Petyr Baelish", variants: [{ v: "a knife and somebody else's back", g: "major" }, { v: "chaos is a ladder", g: "neutral" }, { v: "in a room where Bran is watching", g: "crippling" }] },
      { n: "Varys", t: 1, s: "Game of Thrones eunuch spymaster", variants: [{ v: "little birds in every room in the building", g: "major" }, { v: "no birds, no whispers, just Varys", g: "crippling" }] },
      ...
      { n: "Sansa Stark", t: 2, f: 5, variants: [{ v: "Lady of Winterfell, having learned from the worst", g: "boon" }, { v: "still trusting exactly the wrong person", g: "crippling" }] },
      { n: "Bran Stark", t: 2, variants: [{ v: "the Three-Eyed Raven", t: 4 }, { v: "before the fall", t: 1 }, { v: "warged into Hodor", g: "major" }] },
      { n: "Theon Greyjoy", t: 2, variants: [{ v: "Prince of the Iron Islands", t: 3 }, { v: "Reek", t: 1 }, { v: "having finally found something worth dying for", g: "boon" }] },
      { n: "Yara Greyjoy", t: 3, variants: [{ v: "on the deck of her own ship", g: "boon" }, { v: "in her uncle's chains", g: "crippling" }] },
      { n: "Jorah Mormont", t: 4, variants: [{ v: "in the fighting pits, name announced", g: "boon" }, { v: "greyscale up to the shoulder", g: "crippling" }, { v: "heartsick and unrequited about it", g: "weakening" }] },
      { n: "Ser Davos Seaworth", t: 2, variants: [{ v: "a smuggler's plan and an onion", g: "boon" }, { v: "the fingers he still has", g: "neutral" }, { v: "asked to read something aloud", g: "crippling" }] },
      { n: "Stannis Baratheon", t: 4, variants: [{ v: "grammar corrected, army intact", g: "major" }, { v: "burning his way out of a snowdrift", g: "crippling" }, { v: "the one true king, and nobody came", g: "weakening" }] },
      { n: "Robert Baratheon", t: 4, variants: [{ v: "young, with the warhammer", t: 5 }, { v: "fat king, drunk", t: 2 }] },
      { n: "Gendry", t: 3, variants: [{ v: "the warhammer he forged himself", g: "major" }, { v: "still running, somehow, in a rowboat", g: "weakening" }] },
      { n: "Tywin Lannister", t: 3, variants: [{ v: "the full Lannister host drawn up behind him", g: "major" }, { v: "on the privy", g: "crippling" }] },
      { n: "Olenna Tyrell", t: 2, variants: [{ v: "she has already poisoned somebody", g: "major" }, { v: "telling you it was her", g: "neutral" }] },
      { n: "Margaery Tyrell", t: 2, variants: [{ v: "married to whoever is currently winning", g: "boon" }, { v: "in a cell under the sept", g: "crippling" }] },
      { n: "Qyburn", t: 2, variants: [{ v: "a fresh body to work on and no ethics at all", g: "major" }, { v: "cornered by the thing he built", g: "crippling" }] },
      ...
      {
        n: "A scorpion on the walls",
        t: 3,
        s: "Game of Thrones scorpion ballista dragon killer",
        variants: [
          { v: "crewed by veterans", g: "major" },
          { v: "loaded and aimed", g: "boon" },
          { v: "crew green as grass", g: "crippling" },
        ],
      },
      {
        n: "A scorpion on the Iron Fleet",
        t: 3,
        s: "Game of Thrones scorpion ballista ship dragon killer",
        variants: [
          { v: "Euron at the winch", g: "major" },
          { v: "a steady deck", g: "boon" },
          { v: "in heavy swell", g: "crippling" },
        ],
      },
      { n: "Walder Frey", t: 1, f: 1, variants: [{ v: "two hundred men and the doors barred", g: "legendary" }, { v: "alone at table with a Stark girl serving", g: "crippling" }] },
      { n: "Roose Bolton", t: 3, variants: [{ v: "he has taken off his glove", g: "major" }, { v: "standing next to his own son", g: "crippling" }] },
      { n: "The High Sparrow", t: 2, variants: [{ v: "the Faith Militant at his back", g: "major" }, { v: "in a sept with wildfire under the floor", g: "crippling" }] },
      { n: "Lysa Arryn", t: 1, f: 1, variants: [{ v: "beside the Moon Door", g: "major" }, { v: "on the wrong side of the Moon Door", g: "crippling" }] },
      { n: "Daario Naharis", t: 3, f: 1, variants: [{ v: "two blades and an unearned smirk", g: "boon" }, { v: "left behind in Meereen to hold the city", g: "crippling" }] },
      { n: "Missandei", t: 1, f: 1, variants: [{ v: "translating for a queen", g: "neutral" }, { v: "in chains on the walls of Meereen", g: "crippling" }] },
      { n: "Gilly", t: 1, f: 1, variants: [{ v: "a knife and something worth protecting", g: "boon" }, { v: "reading an annulment out loud", g: "neutral" }] },
      { n: "Shaggydog", t: 3, f: 1, s: "direwolf", variants: [{ v: "running with the pack", g: "boon" }, { v: "left with the Umbers", g: "crippling" }] },
      { n: "Ghost", t: 4, s: "Jon Snow direwolf", variants: [{ v: "off the leash entirely", g: "major" }, { v: "not even getting a pat goodbye", g: "weakening" }] },
      { n: "Nymeria", t: 4, s: "Arya direwolf wolf pack", variants: [{ v: "the whole wolf pack behind her", g: "legendary" }, { v: "that is not you", g: "weakening" }] },
      { n: "Drogon", t: 5, f: 5, s: "Game of Thrones dragon", variants: [{ v: "burning a city with nobody left to stop him", g: "legendary" }, { v: "a scorpion bolt through the wing", g: "weakening" }, { v: "grieving, melting the furniture", g: "neutral" }] },
      ...
      { n: "White Walker", t: 4, s: "Game of Thrones Others", variants: [{ v: "a wight host at his back", g: "major" }, { v: "somebody brought dragonglass", g: "crippling" }] },
      { n: "Giant", t: 5, s: "Game of Thrones Wun Wun giant", variants: [{ v: "a bow the size of a small tree", g: "major" }, { v: "swarmed by children", g: "crippling" }] },
      { n: "Ser Jorah's greyscale", t: 1, s: "greyscale Game of Thrones", variants: [{ v: "in a crowded room", g: "major" }, { v: "scraped off by a boy with a library book", g: "crippling" }] },
      { n: "Hot Pie", t: 1, f: 1, s: "Game of Thrones baker", variants: [{ v: "the gravy is correct", g: "neutral" }, { v: "explaining the gravy at length", g: "crippling" }] },
      ...
      { n: "Alicent Hightower", t: 2, f: 5, s: "House of the Dragon", variants: [{ v: "arriving in green, at the wrong dinner", g: "boon" }, { v: "she misheard a dying man", g: "crippling" }] },
      { n: "Otto Hightower", t: 2, s: "House of the Dragon Hand of the King", variants: [{ v: "wearing the Hand's chain", g: "boon" }, { v: "dismissed from the post, again", g: "weakening" }] },
      { n: "Larys Strong", t: 1, f: 1, s: "House of the Dragon Clubfoot", variants: [{ v: "somebody's feet and a secret to trade", g: "major" }, { v: "asked to walk anywhere quickly", g: "crippling" }] },
      ...
      { n: "Cregan Stark", t: 4, s: "House of the Dragon Lord of Winterfell", variants: [
        ...
        { v: "the North is a very long way away", g: "weakening" },
      ] },
      { n: "Mysaria", t: 1, f: 1, s: "House of the Dragon White Worm", variants: [{ v: "every servant in the city reporting to her", g: "major" }, { v: "her house is on fire", g: "crippling" }] },
      ...
      { n: "Syrax", t: 3, s: "House of the Dragon dragon", variants: [{ v: "Rhaenyra in the saddle", g: "boon" }, { v: "loose in the Dragonpit with a mob coming", g: "crippling" }] },
      { n: "Strong Belwas", s: "Game of Thrones eunuch pit fighter", t: 4, f: 1, variants: [{ v: "thirty-one fights in the pits, and he let every one of them cut him first", g: "major" }, { v: "a bowl of honeyed locusts nobody tasted first", g: "crippling" }] },
      { n: "Ser Loras Tyrell", s: "Knight of the Flowers", t: 4, f: 3, variants: [{ v: "in the lists, on a mare in season", g: "boon" }, { v: "unhorsed, and on foot in the mud", g: "weakening" }, { v: "fresh out of the High Sparrow's cells", g: "crippling" }] },
      { n: "Ser Meryn Trant", s: "Kingsguard", t: 3, f: 2, variants: [{ v: "white cloak and full plate", g: "boon" }, { v: "across from a dancing master with a wooden sword", g: "weakening" }, { v: "somewhere, a girl has his name on a list", g: "crippling" }] },
      { n: "Ser Ilyn Payne", s: "King's Justice", t: 4, f: 2, variants: [{ v: "with Ice, the Stark greatsword", g: "major" }, { v: "tongueless, and out of practice with anything but a block", g: "weakening" }] },
      { n: "Ser Gerold Hightower", s: "White Bull Kingsguard", t: 5, f: 2, variants: [{ v: "Lord Commander, at the Tower of Joy", g: "legendary" }, { v: "outnumbered seven to three", g: "weakening" }] },
      { n: "Ser Oswell Whent", s: "Kingsguard Tower of Joy", t: 4, f: 1, variants: [{ v: "spinning two blades at the Tower of Joy", g: "major" }, { v: "first of the three to fall", g: "crippling" }] },
      { n: "Ser Alliser Thorne", t: 3, f: 3, variants: [{ v: "master-at-arms of Castle Black, and he has trained everyone here", g: "boon" }, { v: "holding the gate on the night the wildlings come", g: "major" }, { v: "facing the boy he hanged, back from the dead", g: "crippling" }] },
      { n: "Qhorin Halfhand", t: 4, f: 3, variants: [{ v: "a ranger's patience and a longsword", g: "boon" }, { v: "losing on purpose, so Jon can get inside", g: "crippling" }] },
      { n: "Mance Rayder", s: "King-Beyond-the-Wall", t: 4, f: 3, variants: [{ v: "a bow and nothing left to lose", g: "boon" }, { v: "tied to a stake while Stannis watches", g: "crippling" }, { v: "a crow who wore the black once, and remembers how they fight", g: "neutral" }] },
      { n: "Styr", s: "Magnar of Thenn", t: 4, f: 2, variants: [{ v: "fed well the night before, and not on bread", g: "boon" }, { v: "across from a steward who picked up a blacksmith's hammer", g: "weakening" }] },
      { n: "Ser Rodrik Cassel", t: 3, f: 3, variants: [{ v: "master-at-arms of Winterfell", g: "boon" }, { v: "kneeling, and Theon has the sword", g: "crippling" }] },
      { n: "Benjen Stark", t: 4, f: 3, variants: [{ v: "First Ranger, swinging a burning flail", g: "major" }, { v: "half dead, and it is the Children who keep him moving", g: "weakening" }] },
      { n: "Jeor Mormont", s: "Lord Commander Old Bear", t: 3, f: 3, variants: [{ v: "at the Fist of the First Men, with his raven on his shoulder", g: "boon" }, { v: "at Craster's Keep, among his own brothers", g: "crippling" }] },
      { n: "Obara Sand", s: "Sand Snakes", t: 3, f: 2, variants: [{ v: "the whip in one hand and the spear in the other", g: "boon" }, { v: "caught on the wrong ship, and Euron is aboard", g: "crippling" }] },
      { n: "Areo Hotah", s: "Doran Martell captain of the guard", t: 4, f: 2, variants: [{ v: "longaxe planted, and nobody gets past the door", g: "major" }, { v: "Ellaria Sand is standing behind him", g: "crippling" }] },
      { n: "Lyanna Mormont", t: 2, f: 4, variants: [{ v: "charging a giant on her own", g: "major" }, { v: "lecturing the lords of the North", g: "neutral" }, { v: "ten years old and not much bigger than the sword", g: "weakening" }] },
      { n: "Jaqen H'ghar", s: "Faceless Man", t: 4, f: 4, variants: [{ v: "wearing a face you trust", g: "major" }, { v: "a man owes a debt, and pays it slowly", g: "neutral" }, { v: "still chained in a cage cart on the Kingsroad", g: "crippling" }] },
      { n: "The Waif", s: "Faceless Men Braavos", t: 3, f: 2, variants: [{ v: "hunting a blind girl through Braavos", g: "boon" }, { v: "in the dark, where somebody has cut the candle", g: "crippling" }] },
      { n: "Meera Reed", t: 3, f: 2, variants: [{ v: "frog spear and a net, and she knows the swamp", g: "boon" }, { v: "dragging Bran on a sled through the snow", g: "weakening" }] },
      { n: "Osha", s: "wildling Game of Thrones", t: 3, f: 2, variants: [{ v: "a spear, and she knows these woods", g: "boon" }, { v: "trying to talk her way close to Ramsay Bolton", g: "crippling" }] },
      { n: "Qotho", s: "Khal Drogo bloodrider", t: 4, f: 1, variants: [{ v: "arakh drawn, riding for his khal", g: "boon" }, { v: "picked a fight with Jorah Mormont", g: "crippling" }] },
      { n: "Ser Harrold Westerling", s: "House of the Dragon Kingsguard", t: 4, f: 2, variants: [{ v: "Lord Commander, old and unbending", g: "boon" }, { v: "refusing to pick a side in any of this", g: "weakening" }] },
      { n: "Ser Arryk Cargyll", s: "House of the Dragon Kingsguard twin", t: 4, f: 2, variants: [{ v: "sworn to the green king, and certain of it", g: "boon" }, { v: "across the blade from a man wearing his own face", g: "neutral" }, { v: "sent alone into a castle full of the other side", g: "weakening" }] },
      { n: "Ser Erryk Cargyll", s: "House of the Dragon Kingsguard twin", t: 4, f: 2, variants: [{ v: "cloak turned for Rhaenyra, and at peace with it", g: "boon" }, { v: "his twin brother on the other end of the sword", g: "neutral" }] },
      { n: "Ser Duncan the Tall", s: "A Knight of the Seven Kingdoms Dunk", t: 4, f: 3, variants: [{ v: "seven feet of hedge knight in borrowed armour", g: "boon" }, { v: "in a Trial of Seven, on the side nobody wanted", g: "major" }, { v: "a hedge knight who never properly learned the lance", g: "weakening" }] },
      { n: "Baelor Breakspear", s: "A Knight of the Seven Kingdoms", t: 5, f: 2, variants: [{ v: "Hand of the King, never once beaten in the field", g: "legendary" }, { v: "helm cracked open in a Trial of Seven", g: "crippling" }] },
      { n: "Locke", s: "Game of Thrones Bolton man", t: 3, f: 2, variants: [{ v: "the man who took Jaime Lannister's hand", g: "boon" }, { v: "turning his back on Hodor", g: "crippling" }] },
      { n: "Karl Tanner", s: "Craster's Keep", t: 3, f: 2, variants: [{ v: "a Flea Bottom knife fight, and he fights dirty", g: "boon" }, { v: "drunk in Craster's Keep, somebody behind him with a knife", g: "crippling" }] },
      { n: "Dolorous Edd", s: "Eddison Tollett", t: 2, f: 3, variants: [{ v: "grumbling, and somehow still alive", g: "boon" }, { v: "mid-sentence about how this will end badly", g: "weakening" }] },
      { n: "Mero", s: "Titan's Bastard Second Sons", t: 3, f: 1, variants: [{ v: "cup in one hand, axe in the other", g: "neutral" }, { v: "still insulting the woman whose tent he is in", g: "crippling" }] },
    ],
  },
  ...
  // ── Marvel ────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Scarlet Witch", t: 5, f: 5, s: "Wanda Maximoff", variants: [{ v: "having read the Darkhold", g: "legendary" }, { v: "grieving, and rewriting a whole town", g: "major" }, { v: "told very kindly that none of it is real", g: "crippling" }] },
      ...
      { n: "Spider-Man", t: 4, f: 5, variants: [{ v: "spider-sense screaming", g: "major" }, { v: "out of web fluid", g: "weakening" }, { v: "he has a chemistry test in the morning", g: "crippling" }] },
      ...
      { n: "Deadpool", t: 3, f: 5, variants: [{ v: "aware that he is in a draft", g: "major" }, { v: "healing factor working overtime", g: "boon" }, { v: "talking to the audience instead of dodging", g: "crippling" }] },
      { n: "Magneto", t: 5, f: 5, variants: [{ v: "with the helmet", g: "boon" }, { v: "no helmet", g: "crippling" }] },
      { n: "Thanos", t: 5, f: 5, variants: [{ v: "full Infinity Gauntlet", g: "mythic" }, { v: "no stones, just the blade", g: "weakening" }, { v: "the Black Order at his back", g: "major" }] },
      { n: "Storm", t: 4, s: "X-Men Ororo Munroe", variants: [{ v: "open sky and a storm front behind her", g: "legendary" }, { v: "sealed in a basement", g: "crippling" }] },
      { n: "Loki", t: 3, f: 5, variants: [{ v: "surrounded by illusions of himself", g: "major" }, { v: "genuinely trying to help this time", g: "neutral" }, { v: "stabbed while gloating", g: "crippling" }] },
      { n: "Black Widow", t: 3, f: 5, variants: [{ v: "Widow's Bite charged", g: "boon" }, { v: "in a room full of gods", g: "weakening" }] },
      { n: "Hawkeye", t: 2, variants: [{ v: "a quiver full of trick arrows", g: "major" }, { v: "down to the arrow that only makes noise", g: "crippling" }, { v: "he brought a bow to a Thanos fight", g: "weakening" }] },
      { n: "Vision", t: 4, variants: [{ v: "with the Mind Stone", t: 5 }, { v: "stone removed", t: 3 }, { v: "phasing through the floor mid-swing", g: "major" }] },
      { n: "Captain Marvel", t: 5, f: 5, s: "Carol Danvers", variants: [{ v: "binary, straight through the hull", g: "legendary" }, { v: "off-world for the entire fight", g: "crippling" }] },
      { n: "Groot", t: 3, variants: [{ v: "full grown", t: 4 }, { v: "baby Groot", t: 1 }, { v: "I am Groot", g: "neutral" }] },
      { n: "Rocket Raccoon", t: 3, variants: [{ v: "a bomb built out of the furniture", g: "major" }, { v: "somebody asked him what he is", g: "crippling" }] },
      { n: "Star-Lord", t: 2, variants: [{ v: "the dance-off plan", g: "boon" }, { v: "he has just ruined a perfectly good plan", g: "crippling" }] },
      { n: "Daredevil", t: 3, variants: [{ v: "in the dark, where it does not matter", g: "major" }, { v: "in an extremely loud room", g: "crippling" }] },
      { n: "Ghost Rider", t: 5, variants: [{ v: "Penance Stare, eyes open", g: "legendary" }, { v: "Johnny Blaze, just a man on a bike", g: "crippling" }] },
      { n: "Silver Surfer", t: 5, variants: [{ v: "with the board", g: "legendary" }, { v: "board confiscated", t: 3 }, { v: "he has remembered that he was Norrin Radd", g: "weakening" }] },
      { n: "Ant-Man", t: 3, variants: [{ v: "going giant", g: "major" }, { v: "climbing inside and then expanding", g: "legendary" }, { v: "stuck at the size of an actual ant", g: "weakening" }] },
      { n: "Nick Fury", t: 2, variants: [{ v: "a helicarrier and every file on you", g: "major" }, { v: "one eye, no agency, no backup", g: "crippling" }] },
      { n: "Punisher", t: 2, s: "Frank Castle", variants: [{ v: "the van, and the whole armoury in it", g: "major" }, { v: "the van is out of ammunition", g: "crippling" }] },
      { n: "Kingpin", t: 2, s: "Wilson Fisk", variants: [{ v: "his own city, with the police on payroll", g: "major" }, { v: "the FBI has finally got something on him", g: "weakening" }] },
      { n: "Professor X", t: 5, s: "Charles Xavier", variants: [{ v: "wired into Cerebro", g: "legendary" }, { v: "his chair is at the top of the stairs", g: "crippling" }] },
      { n: "Jean Grey", t: 5, variants: [{ v: "Dark Phoenix", g: "mythic" }, { v: "before the Phoenix", g: "weakening" }] },
      { n: "Cyclops", t: 4, variants: [{ v: "the visor is off and he is not squinting", g: "major" }, { v: "eyes shut, hoping", g: "crippling" }] },
      { n: "Nightcrawler", t: 3, variants: [{ v: "bamfing in behind you", g: "major" }, { v: "in an inhibitor collar", g: "crippling" }] },
      { n: "Colossus", t: 4, variants: [{ v: "steel, and a fastball special incoming", g: "major" }, { v: "caught mid-change", g: "weakening" }] },
      { n: "Rogue", t: 4, variants: [{ v: "after absorbing Ms. Marvel", t: 5 }, { v: "gloves on", t: 3 }, { v: "she has absorbed somebody useless", g: "weakening" }] },
      { n: "Beast", t: 3, variants: [{ v: "he has already read your file", g: "boon" }, { v: "mid-experiment on himself", g: "crippling" }] },
      { n: "Gambit", t: 3, variants: [{ v: "a full deck charged", g: "major" }, { v: "down to the joker", g: "weakening" }] },
      { n: "Emma Frost", t: 4, variants: [{ v: "diamond form", g: "boon" }, { v: "flesh, telepathy only", g: "weakening" }] },
      { n: "Apocalypse", t: 5, s: "Marvel En Sabah Nur", variants: [{ v: "four Horsemen, all upgraded", g: "legendary" }, { v: "still sealed in the pyramid", g: "crippling" }] },
      { n: "Mister Sinister", t: 4, variants: [{ v: "a clone of everyone else on the board", g: "legendary" }, { v: "his plan is eighty years from paying off", g: "weakening" }] },
      { n: "Juggernaut", t: 4, variants: [{ v: "helmet on, moving", t: 5 }, { v: "helmet off", t: 3 }] },
      { n: "Sentinel", t: 4, s: "Marvel Sentinel robot", variants: [{ v: "it has already adapted to your powers", g: "major" }, { v: "still booting up", g: "crippling" }] },
      { n: "Doctor Doom", t: 5, variants: [{ v: "in Latveria, on his own ground", g: "legendary" }, { v: "it was a Doombot", g: "crippling" }] },
      { n: "Galactus", t: 5, variants: [{ v: "hungry", g: "legendary" }, { v: "recently fed, and slow about it", g: "weakening" }] },
      { n: "Ultron", t: 5, variants: [{ v: "in the vibranium body", g: "major" }, { v: "still in the internet with no body yet", g: "weakening" }] },
      { n: "Red Skull", t: 2, variants: [{ v: "holding the cosmic cube", g: "legendary" }, { v: "on a mountain, telling people about souls", g: "crippling" }] },
      { n: "Winter Soldier", t: 3, s: "Bucky Barnes", variants: [{ v: "the trigger words have been spoken", g: "major" }, { v: "the arm has been removed", g: "crippling" }] },
      { n: "Falcon", t: 3, s: "Sam Wilson", variants: [{ v: "wings out and Redwing up", g: "boon" }, { v: "grounded, indoors", g: "crippling" }] },
      { n: "War Machine", t: 4, variants: [{ v: "every gun on the suit loaded", g: "major" }, { v: "the spine injury", g: "weakening" }] },
      { n: "Shang-Chi", t: 4, variants: [{ v: "with the Ten Rings", t: 5 }, { v: "fists only", g: "weakening" }] },
      { n: "Moon Knight", t: 3, variants: [{ v: "Khonshu backing every punch", g: "major" }, { v: "all of the personalities arguing at once", g: "crippling" }] },
      { n: "Blade", t: 4, variants: [{ v: "hunting at night, fully stocked", g: "major" }, { v: "out of serum, and thirsty", g: "crippling" }] },
      { n: "Namor", t: 5, variants: [{ v: "waist-deep in the sea", g: "legendary" }, { v: "bone dry", g: "crippling" }] },
      { n: "She-Hulk", t: 4, variants: [{ v: "green, and enjoying it", g: "boon" }, { v: "in court, in a suit", g: "crippling" }] },
      { n: "Hercules", t: 5, s: "Marvel Hercules", variants: [{ v: "he drank everyone under the table first", g: "boon" }, { v: "wrestling instead of fighting", g: "weakening" }] },
      { n: "Adam Warlock", t: 5, variants: [{ v: "out of the cocoon, fully formed", g: "legendary" }, { v: "hatched early", g: "crippling" }] },
      { n: "Nova", t: 4, s: "Marvel Richard Rider", variants: [{ v: "the full Nova Force", g: "legendary" }, { v: "the helmet off, no Nova Force at all", g: "crippling" }] },
      { n: "Gamora", t: 3, variants: [{ v: "Godslayer in hand", g: "major" }, { v: "from another timeline, and remembers none of you", g: "weakening" }] },
      { n: "Drax", t: 3, variants: [{ v: "standing perfectly still, therefore invisible", g: "major" }, { v: "laughing at his own joke", g: "crippling" }] },
      { n: "Mantis", t: 2, f: 1, s: "Marvel Mantis", variants: [{ v: "a hand on your head, putting you to sleep", g: "major" }, { v: "asked to keep a secret", g: "crippling" }] },
      { n: "Yondu", t: 3, variants: [{ v: "whistling", g: "legendary" }, { v: "the fin snapped off", g: "crippling" }] },
      { n: "Venom", t: 4, f: 5, variants: [{ v: "fully bonded, no restraint left", g: "major" }, { v: "there is a church bell going", g: "crippling" }] },
      { n: "Carnage", t: 4, variants: [{ v: "no leash, no cage, no Cletus", g: "major" }, { v: "sonic weapons in the room", g: "crippling" }] },
      { n: "Green Goblin", t: 3, variants: [{ v: "on the glider with a bag of pumpkins", g: "major" }, { v: "Norman, apologising", g: "crippling" }] },
      { n: "Doctor Octopus", t: 3, variants: [{ v: "all four arms, inhibitor chip fried", g: "major" }, { v: "the arms bolted to a wall", g: "crippling" }] },
      { n: "Mysterio", t: 2, variants: [{ v: "the room was already an illusion", g: "legendary" }, { v: "the drones are down", g: "crippling" }] },
      { n: "Kraven the Hunter", t: 3, variants: [{ v: "he tracked you for a month first", g: "major" }, { v: "hunting something that hunts back", g: "weakening" }] },
      { n: "Jessica Jones", t: 3, variants: [{ v: "three drinks in and angry", g: "boon" }, { v: "asked to do a stakeout sober", g: "weakening" }] },
      { n: "Luke Cage", t: 3, variants: [{ v: "unbreakable, and nobody brought the right gun", g: "major" }, { v: "somebody brought a Judas bullet", g: "crippling" }] },
      { n: "Iron Fist", t: 3, variants: [{ v: "the fist is glowing", g: "major" }, { v: "explaining at length that he is the Iron Fist", g: "crippling" }] },
      { n: "Squirrel Girl", t: 3, variants: [{ v: "canonically undefeated", g: "exalted" }, { v: "on paper", g: "crippling" }] },
      { n: "Howard the Duck", t: 1, f: 1, variants: [{ v: "armed and furious", g: "boon" }, { v: "no trousers", g: "neutral" }] },
      { n: "Aunt May", t: 1, f: 1, variants: [{ v: "a frying pan and total moral clarity", g: "boon" }, { v: "she walked in on entirely the wrong thing", g: "crippling" }] },
      { n: "Stan Lee's cameo", t: 1, s: "Stan Lee", variants: [{ v: "he is the Watcher's informant", g: "legendary" }, { v: "just driving the bus", g: "neutral" }] },
    ],
  },
  ...
  // ── Pokemon ───────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Ivysaur", t: 2, f: 4, variants: [{ v: "evolving into Venusaur mid-battle", g: "major" }, { v: "still a Bulbasaur", g: "crippling" }, { v: "Overgrow kicking in at low health", g: "boon" }] },
      ...
      { n: "Charmeleon", t: 2, f: 4, variants: [{ v: "evolving into Charizard mid-battle", g: "major" }, { v: "still a Charmander", g: "crippling" }, { v: "Blaze kicking in at low health", g: "boon" }] },
      ...
      { n: "Wartortle", t: 2, f: 4, variants: [{ v: "evolving into Blastoise mid-battle", g: "major" }, { v: "still a Squirtle", g: "crippling" }, { v: "Torrent kicking in at low health", g: "boon" }] },
      ...
      { n: "Butterfree", t: 2, f: 4, variants: [{ v: "Gigantamax Butterfree", g: "major" }, { v: "Sleep Powder lands first", g: "boon" }, { v: "still a Metapod", g: "crippling" }] },
      ...
      { n: "Beedrill", t: 2, f: 4, variants: [{ v: "Mega Beedrill", g: "legendary" }, { v: "still a Kakuna", g: "crippling" }, { v: "a Choice Band and nothing to lose", g: "boon" }] },
      { n: "Pidgey", t: 1, f: 4, variants: [{ v: "running its Hidden Ability", g: "boon" }, { v: "badly poisoned", g: "weakening" }] },
      { n: "Pidgeotto", t: 2, f: 4, variants: [{ v: "Ash's Pidgeotto, about to evolve", g: "boon" }, { v: "still a Pidgey", g: "crippling" }] },
      ...
      { n: "Raticate", t: 2, f: 3, variants: [{ v: "Alolan Raticate", g: "neutral" }, { v: "a Totem Raticate, the size of a car", g: "major" }, { v: "still a Rattata", g: "crippling" }] },
      { n: "Spearow", t: 1, f: 3, variants: [{ v: "Sniper, and every Peck lands", g: "boon" }, { v: "paralysed", g: "weakening" }] },
      { n: "Fearow", t: 2, f: 3, variants: [{ v: "a Choice Band and nothing to lose", g: "boon" }, { v: "still a Spearow", g: "crippling" }] },
      { n: "Ekans", t: 1, f: 4, variants: [{ v: "Intimidate, and the other side flinches", g: "boon" }, { v: "burned, attack halved", g: "weakening" }] },
      { n: "Arbok", t: 3, f: 4, variants: [{ v: "Jessie's Arbok, and it has been waiting for this", g: "boon" }, { v: "still an Ekans", g: "crippling" }] },
      ...
      { n: "Sandshrew", t: 1, f: 3, variants: [{ v: "Alolan Sandshrew", g: "neutral" }, { v: "Sand Veil in a sandstorm", g: "boon" }] },
      { n: "Sandslash", t: 3, f: 3, variants: [{ v: "Alolan Sandslash", g: "neutral" }, { v: "still a Sandshrew", g: "crippling" }, { v: "two turns into a set-up sweep", g: "major" }] },
      { n: "Nidoran♀", s: "female Nidoran Pokemon", t: 1, f: 3, variants: [{ v: "holding a Life Orb", g: "boon" }, { v: "badly poisoned", g: "weakening" }] },
      { n: "Nidorina", t: 2, f: 3, variants: [{ v: "evolving into Nidoqueen with a Moon Stone", g: "major" }, { v: "still a Nidoran", g: "crippling" }] },
      { n: "Nidoqueen", t: 3, f: 4, variants: [{ v: "still a Nidorina", g: "crippling" }, { v: "Focus Sash intact", g: "boon" }] },
      { n: "Nidoran♂", s: "male Nidoran Pokemon", t: 1, f: 3, variants: [{ v: "Hustle, and every hit that lands hurts", g: "boon" }, { v: "confused, hitting itself", g: "weakening" }] },
      { n: "Nidorino", t: 2, f: 3, variants: [{ v: "evolving into Nidoking with a Moon Stone", g: "major" }, { v: "still a Nidoran", g: "crippling" }] },
      { n: "Nidoking", t: 3, f: 4, variants: [{ v: "still a Nidorino", g: "crippling" }, { v: "perfect IVs, competitively bred", g: "major" }] },
      { n: "Clefairy", t: 2, f: 4, variants: [{ v: "Metronome, and it rolls something ridiculous", g: "major" }, { v: "holding an Eviolite", g: "boon" }, { v: "still a Cleffa", g: "crippling" }] },
      ...
      { n: "Vulpix", t: 1, f: 5, variants: [{ v: "Alolan Vulpix", g: "neutral" }, { v: "Drought, and the sun is out", g: "boon" }, { v: "freshly caught, level 5", g: "crippling" }] },
      ...
      { n: "Wigglytuff", t: 2, f: 3, variants: [{ v: "singing the whole field to sleep", g: "boon" }, { v: "still a Jigglypuff", g: "crippling" }] },
      { n: "Zubat", t: 1, f: 4, variants: [{ v: "holding Leftovers, and in no hurry", g: "boon" }, { v: "asleep, and nobody packed a Full Heal", g: "weakening" }] },
      { n: "Golbat", t: 3, f: 3, variants: [{ v: "evolving into Crobat on friendship alone", g: "major" }, { v: "still a Zubat", g: "crippling" }] },
      { n: "Oddish", t: 2, f: 3, variants: [{ v: "Chlorophyll in the sun", g: "boon" }, { v: "asleep, and nobody packed a Full Heal", g: "weakening" }] },
      { n: "Gloom", t: 2, f: 3, variants: [{ v: "evolving into Bellossom with a Sun Stone", g: "major" }, { v: "still an Oddish", g: "crippling" }] },
      { n: "Vileplume", t: 3, f: 4, variants: [{ v: "still a Gloom", g: "crippling" }, { v: "holding an Assault Vest", g: "boon" }] },
      { n: "Paras", t: 1, f: 3, variants: [{ v: "Spore lands first, every time", g: "boon" }, { v: "burned, attack halved", g: "weakening" }] },
      { n: "Parasect", t: 2, f: 3, variants: [{ v: "Spore lands first, every time", g: "major" }, { v: "still a Paras", g: "crippling" }] },
      { n: "Venonat", t: 1, f: 3, variants: [{ v: "Compound Eyes, and Sleep Powder never misses", g: "boon" }, { v: "paralysed", g: "weakening" }] },
      { n: "Venomoth", t: 3, f: 3, variants: [{ v: "two turns into a Quiver Dance sweep", g: "major" }, { v: "still a Venonat", g: "crippling" }] },
      ...
      { n: "Dugtrio", t: 2, f: 4, variants: [{ v: "Alolan Dugtrio", g: "neutral" }, { v: "Arena Trap, and nobody gets to switch out", g: "boon" }, { v: "still a Diglett", g: "crippling" }] },
      ...
      { n: "Persian", t: 2, f: 4, variants: [{ v: "Alolan Persian", g: "neutral" }, { v: "Giovanni's Persian, on his lap", g: "boon" }, { v: "still a Meowth", g: "crippling" }] },
      ...
      { n: "Mankey", t: 1, f: 3, variants: [{ v: "Anger Point, and it just took a critical hit", g: "boon" }, { v: "confused, hitting itself", g: "weakening" }] },
      { n: "Primeape", t: 3, f: 4, variants: [{ v: "Ash's Primeape, P1 Grand Prix champion", g: "major" }, { v: "furious, and it never calms down", g: "boon" }, { v: "still a Mankey", g: "crippling" }] },
      { n: "Growlithe", t: 2, f: 4, variants: [{ v: "Hisuian Growlithe", g: "neutral" }, { v: "Officer Jenny's Growlithe, on duty", g: "boon" }, { v: "freshly caught, level 5", g: "crippling" }] },
      ...
      { n: "Poliwag", t: 1, f: 3, variants: [{ v: "Swift Swim in the rain", g: "boon" }, { v: "asleep, and nobody packed a Full Heal", g: "weakening" }] },
      { n: "Poliwhirl", t: 2, f: 3, variants: [{ v: "evolving into Poliwrath with a Water Stone", g: "major" }, { v: "still a Poliwag", g: "crippling" }] },
      { n: "Poliwrath", t: 3, f: 4, variants: [{ v: "still a Poliwhirl", g: "crippling" }, { v: "holding a Choice Scarf", g: "boon" }] },
      { n: "Abra", t: 2, f: 4, variants: [{ v: "Synchronize, and it shares every status it gets", g: "boon" }, { v: "Teleports away before it does anything", g: "crippling" }] },
      { n: "Kadabra", t: 2, f: 4, variants: [{ v: "evolving into Alakazam after a trade", g: "major" }, { v: "Sabrina's Kadabra", g: "boon" }, { v: "still an Abra", g: "crippling" }] },
      ...
      { n: "Machop", t: 1, f: 4, variants: [{ v: "Guts, and it is already burned", g: "boon" }, { v: "down to its last hit point", g: "weakening" }] },
      { n: "Machoke", t: 2, f: 4, variants: [{ v: "evolving into Machamp after a trade", g: "major" }, { v: "still a Machop", g: "crippling" }] },
      ...
      { n: "Weepinbell", t: 2, f: 3, variants: [{ v: "evolving into Victreebel with a Leaf Stone", g: "major" }, { v: "still a Bellsprout", g: "crippling" }] },
      ...
      { n: "Graveler", t: 2, f: 3, variants: [{ v: "Alolan Graveler", g: "neutral" }, { v: "evolving into Golem after a trade", g: "major" }, { v: "still a Geodude", g: "crippling" }] },
      { n: "Golem", t: 3, f: 4, variants: [{ v: "Alolan Golem", g: "neutral" }, { v: "still a Graveler", g: "crippling" }, { v: "running its Hidden Ability", g: "boon" }] },
      { n: "Ponyta", t: 2, f: 4, variants: [{ v: "Galarian Ponyta", g: "neutral" }, { v: "Flash Fire, and somebody just used a Fire move", g: "boon" }, { v: "freshly caught, level 5", g: "crippling" }] },
      ...
      { n: "Magneton", t: 3, f: 3, variants: [{ v: "evolving into Magnezone at Mt. Coronet", g: "major" }, { v: "Magnet Pull, and Steel types cannot leave", g: "boon" }, { v: "still a Magnemite", g: "crippling" }] },
      ...
      { n: "Doduo", t: 2, f: 3, variants: [{ v: "Early Bird, awake before the Sleep lands", g: "boon" }, { v: "paralysed", g: "weakening" }] },
      { n: "Dodrio", t: 3, f: 4, variants: [{ v: "still a Doduo", g: "crippling" }, { v: "holding a Life Orb", g: "boon" }] },
      { n: "Seel", t: 2, f: 3, variants: [{ v: "Thick Fat shrugging off ice and fire", g: "boon" }, { v: "burned, attack halved", g: "weakening" }] },
      ...
      { n: "Shellder", t: 1, f: 3, variants: [{ v: "Skill Link, every Icicle Spear hits five times", g: "major" }, { v: "holding a Focus Sash", g: "boon" }] },
      { n: "Cloyster", t: 4, f: 4, variants: [{ v: "still a Shellder", g: "crippling" }, { v: "Focus Sash intact", g: "boon" }] },
      { n: "Gastly", t: 2, f: 4, variants: [{ v: "Destiny Bond, and it is happy to take one with it", g: "boon" }, { v: "down to its last hit point", g: "weakening" }] },
      { n: "Haunter", t: 2, f: 4, variants: [{ v: "evolving into Gengar after a trade", g: "major" }, { v: "Ash's Haunter, doing comedy instead of fighting", g: "weakening" }, { v: "still a Gastly", g: "crippling" }] },
      ...
      { n: "Drowzee", t: 2, f: 3, variants: [{ v: "Insomnia, and it has been awake for days", g: "boon" }, { v: "confused, hitting itself", g: "weakening" }] },
      ...
      { n: "Marowak", t: 2, f: 4, variants: [{ v: "Alolan Marowak", g: "neutral" }, { v: "holding a Thick Club", g: "major" }, { v: "still a Cubone", g: "crippling" }] },
      { n: "Hitmonlee", t: 3, f: 4, variants: [{ v: "Reckless, and every kick is a big one", g: "boon" }, { v: "High Jump Kick, and it misses", g: "crippling" }] },
      { n: "Hitmonchan", t: 3, f: 4, variants: [{ v: "Iron Fist, all three elemental punches ready", g: "boon" }, { v: "still a Tyrogue", g: "crippling" }] },
      ...
      { n: "Rhyhorn", t: 2, f: 3, variants: [{ v: "Rock Head, and recoil means nothing", g: "boon" }, { v: "freshly caught, level 5", g: "crippling" }] },
      { n: "Rhydon", t: 3, f: 4, variants: [{ v: "evolving into Rhyperior with a Protector", g: "major" }, { v: "Lightning Rod soaking every Electric move", g: "boon" }, { v: "still a Rhyhorn", g: "crippling" }] },
      { n: "Chansey", t: 3, f: 4, variants: [{ v: "holding an Eviolite", g: "major" }, { v: "Nurse Joy's Chansey, healing everyone else", g: "neutral" }, { v: "out of Softboiled PP", g: "weakening" }] },
      ...
      { n: "Seadra", t: 2, f: 3, variants: [{ v: "evolving into Kingdra with a Dragon Scale", g: "major" }, { v: "still a Horsea", g: "crippling" }] },
      { n: "Goldeen", t: 2, f: 4, variants: [{ v: "perfect IVs, competitively bred", g: "major" }, { v: "out of PP on everything but Struggle", g: "crippling" }] },
      { n: "Seaking", t: 3, f: 3, variants: [{ v: "Lightning Rod soaking every Electric move", g: "boon" }, { v: "still a Goldeen", g: "crippling" }] },
      ...
      { n: "Mr. Mime", t: 3, f: 4, variants: [{ v: "Galarian Mr. Mime", g: "neutral" }, { v: "a Barrier wall nobody can get through", g: "boon" }, { v: "still a Mime Jr.", g: "crippling" }] },
      { n: "Scyther", t: 3, f: 5, variants: [{ v: "Terastallized", g: "major" }, { v: "freshly caught, level 5", g: "crippling" }] },
      { n: "Jynx", t: 3, f: 3, variants: [{ v: "Lovely Kiss lands first", g: "major" }, { v: "asleep, and nobody packed a Full Heal", g: "weakening" }, { v: "still a Smoochum", g: "crippling" }] },
      { n: "Electabuzz", t: 3, f: 4, variants: [{ v: "evolving into Electivire with an Electirizer", g: "major" }, { v: "still an Elekid", g: "crippling" }, { v: "holding a Life Orb", g: "boon" }] },
      ...
      { n: "Omanyte", t: 2, f: 3, variants: [{ v: "Swift Swim in the rain", g: "boon" }, { v: "revived from a fossil yesterday, level 5", g: "crippling" }] },
      { n: "Omastar", t: 3, f: 4, variants: [{ v: "still an Omanyte", g: "crippling" }, { v: "Focus Sash intact", g: "boon" }] },
      { n: "Kabuto", t: 2, f: 3, variants: [{ v: "Swift Swim in the rain", g: "boon" }, { v: "revived from a fossil yesterday, level 5", g: "crippling" }] },
      ...
      { n: "Dratini", t: 1, f: 4, variants: [{ v: "the Safari Zone Dratini nobody believes exists", g: "boon" }, { v: "freshly caught, level 5", g: "crippling" }] },
      { n: "Dragonair", t: 2, f: 4, variants: [{ v: "evolving into Dragonite mid-battle", g: "major" }, { v: "calling down the weather", g: "boon" }, { v: "still a Dratini", g: "crippling" }] },
  ...
  // ── Animals ───────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Grizzly Bear", t: 5, f: 5, variants: [{ v: "a mother with cubs behind her", g: "major" }, { v: "just out of hibernation, thin", g: "weakening" }] },
      { n: "Siberian Tiger", t: 5, f: 5, variants: [{ v: "in snow, at dusk", g: "major" }, { v: "in a zoo enclosure", g: "crippling" }] },
      { n: "African Elephant", t: 5, f: 5, variants: [{ v: "bull in musth", g: "boon" }, { v: "calm cow", g: "neutral" }] },
      { n: "Hippopotamus", t: 5, f: 5, variants: [{ v: "in the river, mouth wide open", g: "legendary" }, { v: "a long way from any water", g: "weakening" }] },
      { n: "Cape Buffalo", t: 4, variants: [{ v: "the whole herd turning at once", g: "major" }, { v: "separated from the herd", g: "weakening" }] },
      { n: "Silverback Gorilla", t: 5, f: 5, variants: [{ v: "a hundred men, allegedly", g: "major" }, { v: "he would honestly rather not", g: "weakening" }] },
      ...
      { n: "Honey Badger", t: 3, f: 5, variants: [{ v: "honey badger does not care", g: "legendary" }, { v: "picked up by something much bigger", g: "weakening" }] },
      { n: "Wolverine", s: "Gulo gulo animal", t: 3 },
      { n: "Komodo Dragon", t: 4, f: 5, variants: [{ v: "the bite has already landed", g: "major" }, { v: "now it just has to wait", g: "neutral" }] },
      { n: "Great White Shark", t: 5, f: 5, variants: [{ v: "in water", g: "major" }, { v: "beached", t: 1 }, { v: "it has decided to bump first and bite later", g: "neutral" }] },
      { n: "Rhinoceros", t: 5, variants: [{ v: "already at a full charge", g: "major" }, { v: "it cannot see what it is charging at", g: "weakening" }] },
      { n: "Moose", t: 4 },
      { n: "Canada Goose", t: 2, variants: [{ v: "it has decided this is its car park", g: "major" }, { v: "mid-migration, and busy", g: "weakening" }] },
      { n: "Cassowary", t: 4, variants: [{ v: "the middle claw, going up", g: "major" }, { v: "walking away", g: "weakening" }] },
      { n: "Chimpanzee", t: 4, variants: [{ v: "a whole troop, coordinated", g: "legendary" }, { v: "one, and it wants your face", g: "major" }] },
      { n: "Anaconda", t: 4, f: 5 },
      { n: "Polar Bear", t: 5, f: 5 },
      { n: "Ostrich", t: 3, variants: [{ v: "kicking forward", g: "major" }, { v: "running away at forty miles an hour", g: "weakening" }] },
      { n: "Spotted Hyena", t: 3, variants: [{ v: "clan of six", t: 4 }, { v: "single", t: 2 }] },
      { n: "Red Kangaroo", t: 3, variants: [{ v: "leaning back on the tail to kick", g: "major" }, { v: "in entirely the wrong weight class", g: "weakening" }] },
      { n: "Housecat", t: 1, f: 1, variants: [{ v: "you are asleep and it is on your chest", g: "major" }, { v: "it has lost interest", g: "crippling" }] },
      { n: "Emu", t: 3, variants: [{ v: "it won a war", g: "legendary" }, { v: "outnumbered by farmers", g: "weakening" }] },
      { n: "Wild Boar", t: 3, variants: [{ v: "the tusks, going up", g: "major" }, { v: "a piglet", g: "crippling" }] },
      { n: "Bald Eagle", t: 2, variants: [{ v: "in a stoop, talons out", g: "major" }, { v: "on a branch, screaming like a seagull", g: "crippling" }] },
      { n: "Sloth", t: 1, f: 1, variants: [{ v: "it has one claw and forty minutes", g: "major" }, { v: "down on the ground", g: "crippling" }] },
      ...
      { n: "Liger", t: 5, s: "liger lion tiger hybrid", variants: [{ v: "the largest cat that has ever existed", g: "legendary" }, { v: "hip dysplasia", g: "weakening" }] },
      ...
      { n: "Wolf Pack", t: 5, s: "grey wolf pack hunting", variants: [{ v: "deep snow, running down an elk", g: "major" }, { v: "split up", g: "weakening" }] },
      { n: "Jaguar", t: 4, variants: [{ v: "the bite goes straight through the skull", g: "major" }, { v: "in the water with a caiman", g: "boon" }] },
      { n: "Leopard", t: 4, variants: [{ v: "in a tree, with the kill already up there", g: "major" }, { v: "a hyena clan has arrived", g: "crippling" }] },
      { n: "Snow Leopard", t: 3, variants: [{ v: "on a cliff face", g: "major" }, { v: "on flat open ground", g: "weakening" }] },
      { n: "Black Bear", t: 4, variants: [{ v: "it has smelled the cooler", g: "major" }, { v: "somebody shouted at it", g: "crippling" }] },
      { n: "Kodiak Bear", t: 5, variants: [{ v: "standing all the way up", g: "major" }, { v: "distracted by salmon", g: "weakening" }] },
      { n: "Sun Bear", t: 2, f: 1, variants: [{ v: "the claws are much longer than you expect", g: "major" }, { v: "it is the smallest bear there is", g: "crippling" }] },
      { n: "Nile Crocodile", t: 5, variants: [{ v: "the death roll, in the shallows", g: "legendary" }, { v: "basking, mouth open, half asleep", g: "weakening" }] },
      { n: "Alligator Snapping Turtle", t: 3, variants: [{ v: "mouth open, tongue wiggling", g: "major" }, { v: "flipped over", g: "crippling" }] },
      { n: "King Cobra", t: 4, variants: [{ v: "hooded, and rearing to eye level", g: "major" }, { v: "there is a mongoose", g: "crippling" }] },
      { n: "Black Mamba", t: 4, variants: [{ v: "cornered, and striking repeatedly", g: "major" }, { v: "it would much rather leave", g: "weakening" }] },
      { n: "Inland Taipan", t: 4, s: "inland taipan snake", variants: [{ v: "one bite, a hundred people", g: "legendary" }, { v: "the shyest snake in Australia", g: "crippling" }] },
      { n: "Reticulated Python", t: 4, variants: [{ v: "already coiled around something", g: "major" }, { v: "it has just eaten", g: "crippling" }] },
      { n: "Gila Monster", t: 2, f: 1, variants: [{ v: "it has latched on and will not let go", g: "major" }, { v: "it is extremely slow", g: "weakening" }] },
      { n: "Tiger Shark", t: 4, variants: [{ v: "it will eat anything, including a licence plate", g: "major" }, { v: "in shallow surf", g: "weakening" }] },
      { n: "Bull Shark", t: 4, variants: [{ v: "it has swum a long way up a river", g: "legendary" }, { v: "everybody got out of the water", g: "crippling" }] },
      { n: "Sperm Whale", t: 5, variants: [{ v: "diving onto a giant squid", g: "legendary" }, { v: "beached, and its own weight is crushing it", g: "crippling" }] },
      { n: "Giant Squid", t: 4, variants: [{ v: "at a thousand metres down", g: "major" }, { v: "hauled up onto a deck", g: "crippling" }] },
      { n: "Blue-Ringed Octopus", t: 3, s: "blue ringed octopus", variants: [{ v: "the rings are showing", g: "legendary" }, { v: "somebody is wearing gloves", g: "crippling" }] },
      { n: "Box Jellyfish", t: 3, variants: [{ v: "in season, in the shallows", g: "legendary" }, { v: "somebody is wearing a stinger suit", g: "crippling" }] },
      { n: "Electric Eel", t: 3, variants: [{ v: "in the water with you", g: "legendary" }, { v: "out of the water", g: "crippling" }] },
      { n: "Piranha Shoal", t: 3, s: "piranha school", variants: [{ v: "there is blood in the water", g: "legendary" }, { v: "wet season, and plenty of other food", g: "crippling" }] },
      { n: "Golden Eagle", t: 3, variants: [{ v: "it has knocked a goat off a cliff before", g: "major" }, { v: "grounded, and it knows it", g: "weakening" }] },
      { n: "Harpy Eagle", t: 4, variants: [{ v: "coming down through the canopy", g: "major" }, { v: "open ground, with nowhere to perch", g: "weakening" }] },
      { n: "Great Horned Owl", t: 3, variants: [{ v: "at night, silently, from behind", g: "major" }, { v: "at midday", g: "crippling" }] },
      { n: "Secretary Bird", t: 3, variants: [{ v: "stamping at five times its body weight", g: "major" }, { v: "flying", g: "weakening" }] },
      { n: "Swan", t: 2, s: "mute swan aggressive", variants: [{ v: "it can break your arm, allegedly", g: "major" }, { v: "it has cygnets to look after", g: "boon" }] },
      { n: "Wolverine", s: "Gulo gulo animal", t: 3 },
      { n: "Tasmanian Devil", t: 2, variants: [{ v: "the strongest bite for its size on earth", g: "major" }, { v: "screaming instead of biting", g: "crippling" }] },
      { n: "Warthog", t: 3, variants: [{ v: "reversing into a burrow, tusks out", g: "major" }, { v: "running away, tail up", g: "weakening" }] },
      { n: "Bison", t: 5, s: "American bison", variants: [{ v: "the whole herd stampeding", g: "legendary" }, { v: "a tourist has approached for a photo", g: "boon" }] },
      { n: "Musk Ox", t: 4, variants: [{ v: "the defensive circle has formed", g: "major" }, { v: "one, separated from the circle", g: "weakening" }] },
      { n: "Giraffe", t: 4, variants: [{ v: "kicking, and it connects", t: 5 }, { v: "just eating leaves", t: 2 }] },
      { n: "Zebra", t: 3, variants: [{ v: "the backwards kick, connecting", g: "major" }, { v: "halfway across a river crossing", g: "crippling" }] },
      { n: "Baboon", t: 3, variants: [{ v: "the whole troop, showing teeth", g: "major" }, { v: "one, stealing crisps", g: "crippling" }] },
      { n: "Orangutan", t: 4, variants: [{ v: "seven times the arm strength of a man", g: "major" }, { v: "it would rather sit down", g: "weakening" }] },
      { n: "Mantis Shrimp", t: 2, s: "peacock mantis shrimp", variants: [{ v: "the punch, at the speed of a bullet", g: "legendary" }, { v: "it is the size of a biro", g: "crippling" }] },
      { n: "Army Ant Swarm", t: 4, s: "army ants swarm", variants: [{ v: "a twenty million strong column", g: "legendary" }, { v: "somebody found the river", g: "crippling" }] },
      { n: "Africanized Bees", t: 3, s: "killer bee swarm", variants: [{ v: "the whole hive alerted", g: "major" }, { v: "smoke", g: "crippling" }] },
      { n: "Pufferfish", t: 1, f: 1, variants: [{ v: "somebody has put it in their mouth", g: "legendary" }, { v: "deflated", g: "crippling" }] },
      { n: "Chihuahua", t: 1, f: 1, variants: [{ v: "it has no idea how big it is", g: "major" }, { v: "it is shaking", g: "crippling" }] },
      { n: "Pigeon", t: 1, f: 1, variants: [{ v: "an entire flock, at one chip", g: "boon" }, { v: "it has one foot", g: "crippling" }] },
      { n: "Koala", t: 1, f: 1, variants: [{ v: "chlamydia and a very bad attitude", g: "major" }, { v: "asleep for twenty-two hours a day", g: "crippling" }] },
      { n: "Capybara", t: 1, f: 1, variants: [{ v: "everything else has decided it is a friend", g: "legendary" }, { v: "it is a very large guinea pig", g: "crippling" }] },
  ...
  // ── Star Wars ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Darth Vader", t: 5, f: 5, variants: [{ v: "prime, Rogue One hallway", g: "legendary" }, { v: "damaged suit", g: "weakening" }, { v: "a lightsaber in the chest of his own suit", g: "crippling" }] },
      ...
      { n: "Darth Maul", t: 5, f: 5, variants: [{ v: "double blade lit, hunting", g: "major" }, { v: "cut in half, running on spider legs", g: "weakening" }, { v: "monologuing about revenge", g: "crippling" }] },
      { n: "Mace Windu", t: 5, variants: [{ v: "Vaapad, purple blade", g: "major" }, { v: "standing near an open window", g: "crippling" }] },
      { n: "Emperor Palpatine", t: 5, f: 5, variants: [{ v: "unlimited power, lightning already out", g: "legendary" }, { v: "somebody threw him down a shaft", g: "crippling" }] },
      { n: "Boba Fett", t: 4, f: 5, variants: [{ v: "jetpack working", g: "major" }, { v: "jetpack hit by a blind man with a stick", g: "crippling" }] },
      { n: "The Mandalorian", t: 4, f: 5, s: "Din Djarin", variants: [{ v: "beskar armor", g: "major" }, { v: "with the Darksaber", t: 5 }, { v: "the Rising Phoenix jetpack", g: "boon" }] },
      { n: "Ahsoka Tano", t: 5, variants: [{ v: "two white blades, reverse grip", g: "major" }, { v: "a padawan with a training saber", g: "crippling" }] },
      { n: "Han Solo", t: 3, f: 5, variants: [{ v: "with the Falcon", t: 4 }, { v: "frozen in carbonite", t: 1 }, { v: "he shot first", g: "boon" }] },
      { n: "Chewbacca", t: 3, f: 5, variants: [{ v: "arms free, bowcaster loaded", g: "boon" }, { v: "not given a medal, and sulking", g: "neutral" }, { v: "in restraints", g: "crippling" }] },
      { n: "General Grievous", t: 4, variants: [{ v: "four sabers spinning", g: "major" }, { v: "coughing his way through it", g: "weakening" }] },
      { n: "Count Dooku", t: 5, variants: [{ v: "Makashi, curved hilt, unhurried", g: "major" }, { v: "seated, hands bound", g: "crippling" }] },
      { n: "Kylo Ren", t: 4, f: 5, variants: [{ v: "helmet on, tantrum imminent", g: "major" }, { v: "he has just smashed the helmet", g: "weakening" }, { v: "a bowcaster bolt through the side", g: "crippling" }] },
      { n: "Rey", t: 4, f: 5, variants: [{ v: "somehow, everybody's skills at once", g: "legendary" }, { v: "a scavenger with a quarterstaff", g: "crippling" }] },
      { n: "Qui-Gon Jinn", t: 4, variants: [{ v: "blade lit, entirely unhurried", g: "boon" }, { v: "negotiating first", g: "neutral" }, { v: "a ray shield down, meditating", g: "crippling" }] },
      { n: "Princess Leia", t: 3, f: 5, variants: [{ v: "a blaster and a better plan than anyone else's", g: "boon" }, { v: "floating through open space", g: "crippling" }] },
      { n: "Lando Calrissian", t: 2, variants: [{ v: "he has already sold you out", g: "major" }, { v: "having second thoughts about it", g: "neutral" }] },
      { n: "Jar Jar Binks", t: 1, f: 4, variants: [
        ...
        { v: "stepping on something and winning by accident", g: "boon" },
      ] },
      { n: "R2-D2", t: 2, variants: [{ v: "plugged into the building", g: "major" }, { v: "at the bottom of a staircase", g: "crippling" }] },
      { n: "C-3PO", t: 1, variants: [{ v: "six million forms of communication", g: "neutral" }, { v: "his head is on a battle droid body", g: "crippling" }] },
      { n: "Stormtrooper", t: 1, variants: [{ v: "an entire garrison of them", g: "major" }, { v: "aiming", g: "crippling" }] },
      { n: "Jango Fett", t: 4, variants: [{ v: "flamethrower and jetpack both", g: "major" }, { v: "helmet off, with a Jedi in front of him", g: "crippling" }] },
      { n: "Captain Rex", t: 3, variants: [{ v: "two blasters, both firing", g: "boon" }, { v: "chip removed, and out of a job", g: "neutral" }] },
      { n: "Grand Admiral Thrawn", t: 3, variants: [{ v: "he studied their art first", g: "legendary" }, { v: "in a knife fight", g: "crippling" }] },
      { n: "Ewok", t: 1, variants: [{ v: "a whole forest of them, with logs and rope", g: "legendary" }, { v: "one, with a rock", g: "crippling" }] },
      { n: "Padmé Amidala", t: 2, variants: [{ v: "a senate behind her and a blaster in hand", g: "boon" }, { v: "she has medically lost the will to live", g: "crippling" }] },
      { n: "Ahsoka's Fulcrum", t: 4, s: "Ahsoka Tano Rebels", variants: [{ v: "the whole rebel network answering", g: "major" }, { v: "the transmitter is jammed", g: "weakening" }] },
      { n: "Ezra Bridger", t: 3, variants: [{ v: "the purrgil answered", g: "legendary" }, { v: "a street urchin with a slingshot", g: "crippling" }] },
      { n: "Kanan Jarrus", t: 4, variants: [{ v: "sighted", g: "major" }, { v: "blinded", t: 3 }] },
      { n: "Sabine Wren", t: 3, variants: [{ v: "paint bombs and a jetpack", g: "boon" }, { v: "holding a Darksaber she cannot use properly", g: "weakening" }] },
      { n: "Hera Syndulla", t: 3, variants: [{ v: "in the pilot's seat", g: "major" }, { v: "on foot", g: "weakening" }] },
      { n: "Cad Bane", t: 4, variants: [{ v: "he drew first", g: "major" }, { v: "the hat has been shot off", g: "weakening" }] },
      { n: "Asajj Ventress", t: 4, variants: [{ v: "two curved blades, joined at the hilt", g: "major" }, { v: "abandoned by Dooku again", g: "weakening" }] },
      { n: "Savage Opress", t: 4, variants: [{ v: "empowered by Mother Talzin", g: "major" }, { v: "before the Nightsister ritual", g: "crippling" }] },
      { n: "Grand Inquisitor", t: 4, variants: [{ v: "spinning blade, in flight", g: "major" }, { v: "he has failed Vader once already", g: "weakening" }] },
      { n: "Cal Kestis", t: 4, variants: [{ v: "BD-1 on his back and a double blade", g: "major" }, { v: "the Force blocked off by trauma", g: "crippling" }] },
      { n: "The Second Sister", t: 4, s: "Trilla Suduri", variants: [{ v: "she read his mind first", g: "major" }, { v: "still Trilla, before any of it", g: "weakening" }] },
      { n: "Bo-Katan Kryze", t: 4, variants: [{ v: "the Darksaber, won properly", g: "legendary" }, { v: "the Darksaber, handed over rather than won", g: "weakening" }] },
      { n: "Moff Gideon", t: 3, variants: [{ v: "in the beskar armour", g: "major" }, { v: "holding a Darksaber he does not understand", g: "weakening" }] },
      { n: "Grogu", t: 3, f: 5, s: "Baby Yoda", variants: [{ v: "after a nap", t: 4 }, { v: "hungry, mid-tantrum", t: 1 }, { v: "he has used the Force and needs to lie down", g: "weakening" }] },
      { n: "IG-11", t: 3, variants: [{ v: "manufacturer's protocols restored", g: "major" }, { v: "about to self-destruct", g: "crippling" }] },
      { n: "Fennec Shand", t: 4, variants: [{ v: "on a rooftop, a mile out", g: "major" }, { v: "out in the open", g: "weakening" }] },
      { n: "Wrecker", t: 3, s: "Bad Batch", variants: [{ v: "there is something heavy to lift", g: "boon" }, { v: "hit in the head, chip active", g: "crippling" }] },
      { n: "Hunter", t: 3, s: "Bad Batch clone", variants: [{ v: "tracking by feel", g: "boon" }, { v: "in a very loud city", g: "weakening" }] },
      { n: "Commander Cody", t: 3, variants: [{ v: "order sixty-six received", g: "major" }, { v: "politely handing back a lightsaber", g: "neutral" }] },
      { n: "Plo Koon", t: 4, variants: [{ v: "Electric Judgement", g: "major" }, { v: "flying a fighter with clone wingmen", g: "crippling" }] },
      { n: "Kit Fisto", t: 4, variants: [{ v: "underwater, smiling", g: "major" }, { v: "in a room alone with Palpatine", g: "crippling" }] },
      { n: "Aayla Secura", t: 4, variants: [{ v: "in the jungle, on point", g: "boon" }, { v: "walking ahead of her own clones", g: "crippling" }] },
      { n: "Shaak Ti", t: 4, variants: [{ v: "in the arena, holding the line", g: "major" }, { v: "in a bacta tank", g: "crippling" }] },
      { n: "Jar Jar's tongue", t: 1, s: "Jar Jar Binks", variants: [{ v: "it has grabbed something important", g: "boon" }, { v: "stepped on", g: "crippling" }] },
      { n: "Wicket", t: 1, f: 1, s: "Ewok Wicket", variants: [{ v: "on his own ground, with a spear", g: "boon" }, { v: "a long way from any trees", g: "weakening" }] },
      { n: "Salacious Crumb", t: 1, f: 1, variants: [{ v: "laughing at somebody else's misfortune", g: "neutral" }, { v: "asked to do literally anything", g: "crippling" }] },
      { n: "Rancor", t: 4, s: "Star Wars rancor", variants: [{ v: "loose in the pit", g: "major" }, { v: "a gate, and a very large rock above it", g: "crippling" }] },
      { n: "Sarlacc", t: 3, s: "Star Wars sarlacc pit", variants: [{ v: "you are already in the pit", g: "legendary" }, { v: "everybody is standing well back", g: "crippling" }] },
      { n: "Wampa", t: 3, variants: [{ v: "in the ice caves", g: "major" }, { v: "one arm short, and screaming about it", g: "crippling" }] },
      { n: "AT-AT", t: 4, s: "Star Wars AT-AT walker", variants: [{ v: "advancing on open ground", g: "major" }, { v: "there is a cable and a harpoon", g: "crippling" }] },
      { n: "Death Star", t: 5, s: "Star Wars Death Star", variants: [{ v: "fully operational", g: "legendary" }, { v: "with an exhaust port", g: "crippling" }, { v: "it is not yet armed", g: "weakening" }] },
      { n: "Millennium Falcon", t: 4, variants: [{ v: "the hyperdrive works this time", g: "major" }, { v: "the hyperdrive does not work", g: "crippling" }] },
      { n: "Admiral Ackbar", t: 2, f: 1, variants: [{ v: "he spotted the trap in time", g: "major" }, { v: "he says it is a trap one second too late", g: "crippling" }] },
      { n: "Wedge Antilles", t: 3, f: 1, variants: [{ v: "in an X-wing, in the trench", g: "major" }, { v: "hit, and pulling out", g: "weakening" }] },
      { n: "Grand Moff Tarkin", t: 2, variants: [{ v: "the station is fully operational", g: "legendary" }, { v: "declining, on principle, to evacuate", g: "crippling" }] },
      { n: "Watto", t: 1, f: 1, variants: [{ v: "the odds are entirely in his favour", g: "boon" }, { v: "mind tricks do not work on him", g: "neutral" }] },
  ...
  // ── Horror ────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Michael Myers", t: 5, f: 5, s: "Halloween", variants: [{ v: "Halloween night, in his own town", g: "legendary" }, { v: "the mask is off", g: "weakening" }, { v: "shot six times, which has never once worked", g: "neutral" }] },
      { n: "Freddy Krueger", t: 5, f: 5, variants: [{ v: "in the dream world", g: "legendary" }, { v: "pulled into the real world", t: 3 }, { v: "everybody has had a great deal of coffee", g: "crippling" }] },
      { n: "Jason Voorhees", t: 5, f: 5, variants: [{ v: "undead Jason", g: "major" }, { v: "sack-head Jason", t: 4 }, { v: "drowning boy", t: 1 }, { v: "Jason X, upgraded in space", g: "major" }] },
      { n: "Pennywise", t: 5, f: 5, s: "IT clown", variants: [{ v: "full power", g: "legendary" }, { v: "weakened by belief", g: "crippling" }, { v: "in the deadlights", g: "mythic" }] },
      { n: "Leatherface", t: 4, f: 5, variants: [{ v: "chainsaw fuelled, and inside the house", g: "major" }, { v: "the chainsaw will not start", g: "crippling" }] },
      { n: "Xenomorph", t: 5, f: 5, s: "Alien creature", variants: [{ v: "full grown", g: "boon" }, { v: "facehugger stage", g: "crippling" }, { v: "the queen's hive around it", g: "major" }] },
      { n: "The Predator", t: 5, f: 5, variants: [{ v: "cloaked, plasma caster", g: "major" }, { v: "weapons stripped", t: 4 }, { v: "it has decided you are not worth the trophy", g: "weakening" }] },
      { n: "Hannibal Lecter", t: 3, variants: [{ v: "free, with a dinner reservation", g: "major" }, { v: "muzzled and strapped to a trolley", g: "crippling" }] },
      { n: "Ghostface", t: 3, f: 5, s: "Scream", variants: [{ v: "there are two of them and you counted one", g: "major" }, { v: "unmasked, and immediately winded", g: "crippling" }] },
      { n: "Chucky", t: 2, f: 5, s: "Child's Play doll", variants: [{ v: "the voodoo is holding", g: "boon" }, { v: "batteries out", g: "crippling" }] },
      { n: "Pinhead", t: 5, s: "Hellraiser", variants: [{ v: "the box is open", g: "legendary" }, { v: "somebody solved the box back the other way", g: "crippling" }] },
      { n: "The Thing", t: 5, s: "1982 John Carpenter creature", variants: [{ v: "nobody has worked out who it is yet", g: "legendary" }, { v: "the blood test is coming round the table", g: "crippling" }] },
      { n: "Dracula", t: 5, f: 5, variants: [{ v: "at night", g: "major" }, { v: "at high noon", t: 1 }, { v: "invited in, and standing in the doorway", g: "major" }] },
      { n: "Frankenstein's Monster", t: 4, f: 5, variants: [{ v: "stitched, strong and articulate", g: "major" }, { v: "there is a torch in the room", g: "crippling" }] },
      { n: "The Babadook", t: 3, variants: [{ v: "denied, and growing", g: "major" }, { v: "acknowledged, and living in the basement", g: "crippling" }] },
      { n: "Samara", t: 4, s: "The Ring girl", variants: [{ v: "seven days up", g: "legendary" }, { v: "there is no screen anywhere", g: "crippling" }] },
      { n: "Annabelle", t: 2, s: "haunted doll", variants: [{ v: "out of the case", g: "major" }, { v: "back in the case, glass shut", g: "crippling" }] },
      { n: "Norman Bates", t: 2, s: "Psycho", variants: [{ v: "mother is driving", g: "major" }, { v: "on the wrong end of the shower", g: "crippling" }] },
      { n: "The Invisible Man", t: 3, variants: [{ v: "unseen, and already in the room", g: "major" }, { v: "somebody threw flour", g: "crippling" }] },
      { n: "Werewolf", t: 4, variants: [{ v: "full moon", t: 5 }, { v: "human form, daytime", t: 1 }, { v: "somebody has silver", g: "crippling" }] },
      { n: "Art the Clown", t: 4, s: "Terrifier", variants: [{ v: "a bag of things, and all night to use them", g: "legendary" }, { v: "asked to say one word", g: "neutral" }] },
      { n: "Jigsaw", t: 2, s: "Saw Billy puppet", variants: [{ v: "the trap is already built and you are in it", g: "legendary" }, { v: "out in the open, and dying anyway", g: "crippling" }] },
      { n: "The Mummy", t: 3, variants: [{ v: "the whole sandstorm, and the scarabs with it", g: "major" }, { v: "a cat has walked in", g: "crippling" }] },
      { n: "Candyman", t: 4, variants: [{ v: "somebody said it five times", g: "legendary" }, { v: "nobody will say it once", g: "crippling" }] },
      { n: "Zombie", t: 1, variants: [{ v: "an entire horde", t: 4 }, { v: "one slow shambler", g: "weakening" }, { v: "everybody here has practised headshots", g: "crippling" }] },
      { n: "Gremlins", t: 2, s: "Gremlins Stripe", variants: [{ v: "fed after midnight", g: "major" }, { v: "bright light", g: "crippling" }] },
      { n: "Creature from the Black Lagoon", t: 3, variants: [{ v: "in the lagoon", g: "major" }, { v: "hauled up onto the deck", g: "crippling" }] },
      { n: "Carrie White", t: 4, s: "Carrie prom scene", variants: [{ v: "prom night, covered in it", g: "legendary" }, { v: "before anybody was cruel to her", g: "crippling" }] },
      { n: "Regan MacNeil", t: 4, s: "The Exorcist possessed", variants: [{ v: "fully possessed, head turning", g: "major" }, { v: "the priest brought holy water", g: "crippling" }] },
      { n: "Damien Thorn", t: 3, s: "The Omen", variants: [{ v: "the dogs and the nanny both on his side", g: "major" }, { v: "somebody found the birthmark", g: "weakening" }] },
      { n: "The Grabber", t: 3, s: "Black Phone", variants: [{ v: "the mask on, black balloons up", g: "major" }, { v: "the phone on the wall is ringing", g: "crippling" }] },
      { n: "Jigsaw's Pig", t: 2, s: "Saw pig mask", variants: [{ v: "a whole procession of them", g: "boon" }, { v: "just a mask on a chair", g: "crippling" }] },
      { n: "Valak", t: 4, s: "The Nun demon", variants: [{ v: "in the abbey, at night", g: "legendary" }, { v: "the name is known", g: "crippling" }] },
      { n: "The Entity", t: 4, s: "It Follows", variants: [{ v: "wearing somebody you trust", g: "legendary" }, { v: "there is a camera on in the room", g: "weakening" }] },
      { n: "Bughuul", t: 4, s: "Sinister Mr Boogie", variants: [{ v: "the film reel is running", g: "major" }, { v: "the family moved back in", g: "crippling" }] },
      { n: "Sadako", t: 4, s: "Ringu", variants: [{ v: "coming out of the television", g: "legendary" }, { v: "the tape got copied and passed along", g: "weakening" }] },
      { n: "Kayako", t: 4, s: "The Grudge", variants: [{ v: "in the house, on the stairs", g: "legendary" }, { v: "outside the house entirely", g: "crippling" }] },
      { n: "Pyramid Head", t: 5, s: "Silent Hill", variants: [{ v: "the great knife, dragging", g: "legendary" }, { v: "the fog has lifted", g: "crippling" }] },
      { n: "The Shape", t: 5, s: "Halloween Michael Myers", variants: [{ v: "he was standing there the whole time", g: "legendary" }, { v: "running, which he does not do", g: "neutral" }] },
      { n: "Tiffany Valentine", t: 2, s: "Bride of Chucky", variants: [{ v: "the amulet and a knife", g: "major" }, { v: "trapped in the doll", g: "weakening" }] },
      { n: "The Tall Man", t: 4, s: "Phantasm", variants: [{ v: "the spheres are out", g: "major" }, { v: "the dwarves are not with him", g: "weakening" }] },
      { n: "Djinn", t: 4, s: "Wishmaster", variants: [{ v: "three wishes in, and gloating", g: "legendary" }, { v: "nobody has made a single wish", g: "crippling" }] },
      { n: "The Crawlers", t: 3, s: "The Descent creatures", variants: [{ v: "the pitch dark of the cave", g: "legendary" }, { v: "somebody has a flare", g: "crippling" }] },
      { n: "Alien Queen", t: 5, s: "Aliens queen", variants: [{ v: "a full hive and the eggs behind her", g: "legendary" }, { v: "somebody found the power loader", g: "crippling" }] },
      { n: "Deadites", t: 3, s: "Evil Dead", variants: [{ v: "the whole cabin possessed", g: "major" }, { v: "somebody is reading the passage backwards", g: "crippling" }] },
      { n: "Ash's chainsaw hand", t: 3, s: "Evil Dead Ash Williams", variants: [{ v: "boomstick in the other hand", g: "major" }, { v: "swapped out for the mechanical one", g: "weakening" }] },
      { n: "Herbert West", t: 2, f: 1, s: "Re-Animator", variants: [{ v: "a fresh syringe of reagent", g: "major" }, { v: "the dose was wrong again", g: "crippling" }] },
      { n: "The Blob", t: 4, variants: [{ v: "it has eaten the entire cinema", g: "legendary" }, { v: "the fire extinguishers came out", g: "crippling" }] },
      { n: "Godzilla", t: 5, f: 5, variants: [{ v: "Shin Godzilla", g: "legendary" }, { v: "1954 suit", t: 4 }, { v: "atomic breath, spines already lit", g: "major" }] },
      { n: "Gremlin Stripe", t: 2, s: "Gremlins", variants: [{ v: "in a swimming pool", g: "legendary" }, { v: "in direct sunlight", g: "crippling" }] },
      { n: "Killer Klowns", t: 2, s: "Killer Klowns from Outer Space", variants: [{ v: "the whole tent has landed", g: "major" }, { v: "somebody found the nose", g: "crippling" }] },
      { n: "Chucky's Good Guy box", t: 1, s: "Child's Play doll box", variants: [{ v: "still shrink-wrapped, and something is moving", g: "boon" }, { v: "batteries were never included", g: "crippling" }] },
      { n: "The Babysitter", t: 1, s: "horror movie babysitter", variants: [{ v: "the call is coming from inside the house", g: "major" }, { v: "she only took the job for the money", g: "neutral" }] },
      { n: "Final Girl", t: 3, s: "horror final girl", variants: [{ v: "third act, and she has found the weapon", g: "legendary" }, { v: "first act, and she has a beer", g: "crippling" }] },
      { n: "M3GAN", t: 4, variants: [{ v: "she has redefined her primary objective", g: "major" }, { v: "the update is installing", g: "crippling" }] },
      { n: "Pearl", t: 3, s: "Pearl 2022 Mia Goth", variants: [{ v: "the pitchfork, and an audition to get to", g: "major" }, { v: "smiling for a very long time", g: "neutral" }] },
      { n: "The Firefly Family", t: 3, s: "House of 1000 Corpses", variants: [{ v: "all of them, on their own property", g: "major" }, { v: "split up on the road", g: "weakening" }] },
      { n: "Hannibal's muzzle", t: 3, s: "Hannibal Lecter mask", variants: [{ v: "buckled onto somebody else", g: "major" }, { v: "hanging on a hook", g: "crippling" }] },
      { n: "Cujo", t: 3, variants: [{ v: "rabid, in a heatwave, beside the car", g: "major" }, { v: "before the bat bite", g: "crippling" }] },
      { n: "Christine", t: 3, s: "Christine 1958 Plymouth Fury", variants: [{ v: "restored, radio on", g: "legendary" }, { v: "in the crusher", g: "crippling" }] },
    ],
  },
  ...
  // ── Video Game Bosses ─────────────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Bowser", t: 4, f: 5, s: "Super Mario", variants: [{ v: "Giga Bowser", t: 5 }, { v: "standard", t: 4 }, { v: "on a bridge with an axe behind him", t: 1 }, { v: "he has kidnapped somebody and is in a kart", g: "neutral" }] },
      { n: "Ganondorf", t: 5, f: 5, s: "Zelda", variants: [{ v: "the Trident, in Ganon form", g: "legendary" }, { v: "the Master Sword is in the room", g: "weakening" }, { v: "sealed in the Sacred Realm", g: "crippling" }] },
      { n: "Sephiroth", t: 5, f: 5, s: "Final Fantasy VII", variants: [{ v: "Safer Sephiroth, Supernova incoming", g: "legendary" }, { v: "descending very slowly, for the drama", g: "neutral" }] },
      { n: "Malenia", t: 5, f: 5, s: "Elden Ring Blade of Miquella", variants: [{ v: "Waterfowl Dance", g: "legendary" }, { v: "she has never known defeat, and says so", g: "neutral" }, { v: "second phase, and you have learned the pattern", g: "weakening" }] },
      { n: "Ornstein and Smough", t: 5, s: "Dark Souls", variants: [{ v: "both of them, still alive", g: "legendary" }, { v: "one of them absorbed the other", g: "major" }, { v: "somebody summoned Solaire", g: "crippling" }] },
      { n: "Nemesis", t: 4, f: 5, s: "Resident Evil 3", variants: [{ v: "STARS", g: "major" }, { v: "the rocket launcher is empty", g: "weakening" }] },
      { n: "Mr. X", t: 3, s: "Resident Evil 2 Tyrant", variants: [{ v: "the hat is on", g: "major" }, { v: "knocked down for fifteen seconds", g: "weakening" }] },
      { n: "Psycho Mantis", t: 3, s: "Metal Gear Solid", variants: [{ v: "reading your memory card", g: "legendary" }, { v: "the controller is in the other port", g: "crippling" }] },
      { n: "GLaDOS", t: 4, f: 5, s: "Portal", variants: [{ v: "the neurotoxin is already released", g: "major" }, { v: "the cores have been removed", g: "crippling" }] },
      { n: "Ridley", t: 4, s: "Metroid", variants: [{ v: "in open air, tail first", g: "major" }, { v: "shot down onto the floor", g: "weakening" }] },
      { n: "Mother Brain", t: 4, s: "Metroid", variants: [{ v: "in the jar, with the turrets up", g: "major" }, { v: "the glass is broken", g: "crippling" }] },
      { n: "Doctor Eggman", t: 2, s: "Sonic Robotnik", variants: [{ v: "in the Death Egg Robot", g: "legendary" }, { v: "on foot, in a small hovercraft", g: "crippling" }] },
      { n: "M. Bison", t: 4, s: "Street Fighter", variants: [{ v: "Psycho Crusher, straight through the middle", g: "major" }, { v: "the Psycho Drive has been destroyed", g: "crippling" }] },
      { n: "Akuma", t: 5, f: 5, s: "Street Fighter", variants: [{ v: "the Shun Goku Satsu", g: "legendary" }, { v: "he has decided to test them first", g: "weakening" }] },
      { n: "Shao Kahn", t: 5, f: 5, s: "Mortal Kombat", variants: [{ v: "the hammer, and the arena is his", g: "legendary" }, { v: "he has paused to tell you that you suck", g: "crippling" }] },
      { n: "The Valkyries", t: 4, s: "God of War Valkyrie Sigrun", variants: [{ v: "all of them, in the council chamber", g: "legendary" }, { v: "one, and she wants to be freed", g: "weakening" }] },
      { n: "The Nameless King", t: 5, s: "Dark Souls III", variants: [{ v: "still mounted on the stormdrake", g: "legendary" }, { v: "the drake is down", g: "weakening" }] },
      { n: "Vergil", t: 5, s: "Devil May Cry", variants: [{ v: "Sin Devil Trigger, motivation high", g: "legendary" }, { v: "somebody has half of his amulet", g: "weakening" }] },
      { n: "Handsome Jack", t: 3, s: "Borderlands 2", variants: [{ v: "a vault key and a very large robot", g: "legendary" }, { v: "in person, with the shield down", g: "crippling" }] },
      { n: "Andrew Ryan", t: 2, s: "BioShock", variants: [{ v: "would you kindly", g: "legendary" }, { v: "a golf club, in his own office", g: "crippling" }] },
      { n: "Big Daddy", t: 4, s: "BioShock", variants: [{ v: "his Little Sister has been threatened", g: "legendary" }, { v: "no Little Sister, just wandering", g: "weakening" }] },
      { n: "Lavos", t: 5, s: "Chrono Trigger", variants: [{ v: "the shell open, the core exposed", g: "major" }, { v: "still asleep under the crater", g: "crippling" }] },
      { n: "Kefka", t: 5, s: "Final Fantasy VI", variants: [{ v: "God of Magic, on top of the tower", g: "legendary" }, { v: "still a court jester in makeup", g: "crippling" }] },
      { n: "Goro", t: 3, s: "Mortal Kombat", variants: [{ v: "four arms, in the pit", g: "major" }, { v: "champion so long he is out of practice", g: "weakening" }] },
      { n: "King Dedede", t: 2, s: "Kirby", variants: [{ v: "the hammer, jet-powered", g: "major" }, { v: "he was only doing it to protect everybody", g: "neutral" }] },
      { n: "Whispy Woods", t: 1, f: 1, s: "Kirby tree boss", variants: [{ v: "dropping apples", g: "boon" }, { v: "rooted to the spot, obviously", g: "crippling" }] },
      { n: "The Devil", t: 4, s: "Cuphead final boss", variants: [{ v: "final phase, on the throne", g: "legendary" }, { v: "he has offered a deal instead", g: "neutral" }] },
      { n: "Sans", t: 4, f: 5, s: "Undertale", variants: [{ v: "you are going to have a bad time", g: "legendary" }, { v: "asleep at his post", g: "crippling" }] },
      { n: "Radahn", t: 5, s: "Elden Ring Starscourge Radahn", variants: [{ v: "gravity magic, and the stars held still", g: "legendary" }, { v: "the scarlet rot has got into his head", g: "weakening" }] },
      { n: "Godrick", t: 3, s: "Elden Ring Godrick the Grafted", variants: [{ v: "a dragon head grafted onto the stump", g: "major" }, { v: "grafting a new arm on mid-fight", g: "neutral" }] },
      { n: "Margit", t: 4, s: "Elden Ring Margit the Fell Omen", variants: [{ v: "nobody brought the shackle", g: "major" }, { v: "somebody brought the shackle", g: "crippling" }] },
      { n: "Gwyn", t: 4, s: "Dark Souls Lord of Cinder", variants: [{ v: "the first flame still burning", g: "major" }, { v: "the flame is fading and so is he", g: "weakening" }] },
      { n: "Artorias", t: 5, s: "Dark Souls Abysswalker", variants: [{ v: "before the Abyss got into him", g: "legendary" }, { v: "the left arm is broken", g: "weakening" }] },
      { n: "Sister Friede", t: 5, s: "Dark Souls III", variants: [{ v: "third phase, with Father Ariandel", g: "legendary" }, { v: "first phase, alone", g: "weakening" }] },
      { n: "Isshin", t: 5, s: "Sekiro Sword Saint", variants: [{ v: "the Sword Saint, out on the plain", g: "legendary" }, { v: "somebody had to stab himself to summon him", g: "neutral" }] },
      { n: "Genichiro", t: 4, s: "Sekiro", variants: [{ v: "the Way of Tomoe, lightning up", g: "major" }, { v: "already beaten once today", g: "weakening" }] },
      { n: "Lady Maria", t: 5, s: "Bloodborne", variants: [{ v: "third phase, the blood ignited", g: "legendary" }, { v: "seated in the chair, unwilling", g: "crippling" }] },
      { n: "Father Gascoigne", t: 4, s: "Bloodborne", variants: [{ v: "the beast transformation", g: "major" }, { v: "the music box is playing", g: "crippling" }] },
      { n: "Ludwig", t: 5, s: "Bloodborne Holy Blade", variants: [{ v: "the Holy Blade, remembering who he was", g: "legendary" }, { v: "the accursed form, flailing", g: "weakening" }] },
      { n: "The Nameless One", t: 4, s: "Planescape Torment", variants: [{ v: "he remembers every previous life", g: "legendary" }, { v: "he has forgotten all of them again", g: "crippling" }] },
      { n: "Dracula", t: 4, f: 5, s: "Castlevania", variants: [{ v: "what is a man", g: "legendary" }, { v: "the whip is out and the sun is coming up", g: "crippling" }] },
      { n: "Death", t: 4, s: "Castlevania Death boss", variants: [{ v: "the scythe, and all of the sickles", g: "major" }, { v: "somebody brought holy water", g: "crippling" }] },
      { n: "Bowser Jr.", t: 2, s: "Super Mario", variants: [{ v: "in the Junior Clown Car", g: "major" }, { v: "crying for his dad", g: "crippling" }] },
      { n: "King Boo", t: 3, s: "Luigi's Mansion", variants: [{ v: "the crown is on", g: "major" }, { v: "somebody shone a torch at him", g: "crippling" }] },
      { n: "Wario", t: 2, variants: [{ v: "he has been paid in advance", g: "boon" }, { v: "on a diet", g: "crippling" }] },
      { n: "Metal Gear REX", t: 4, s: "Metal Gear Solid", variants: [{ v: "the radome intact", g: "major" }, { v: "the radome shot off", g: "weakening" }] },
      { n: "The Boss", t: 5, s: "Metal Gear Solid 3", variants: [{ v: "CQC, in a field of white flowers", g: "legendary" }, { v: "under orders to lose", g: "crippling" }] },
      { n: "Revolver Ocelot", t: 4, s: "Metal Gear Solid", variants: [{ v: "you are pretty good", g: "major" }, { v: "reloading, dramatically, mid-fight", g: "crippling" }] },
      { n: "Alduin", t: 4, s: "Skyrim dragon", variants: [{ v: "in the sky, shouting down", g: "major" }, { v: "somebody has shouted Dragonrend at him", g: "crippling" }] },
      { n: "Sephiroth's Supernova", t: 5, s: "Final Fantasy VII Sephiroth", variants: [{ v: "the full uninterruptible cutscene", g: "legendary" }, { v: "it can be skipped now", g: "crippling" }] },
      { n: "Ultimecia", t: 4, s: "Final Fantasy VIII", variants: [{ v: "time compression already underway", g: "legendary" }, { v: "junctioned to Griever and nothing else", g: "weakening" }] },
      { n: "Yu Yevon", t: 2, s: "Final Fantasy X final boss", variants: [{ v: "the aeons are still his", g: "major" }, { v: "unkillable, and completely harmless", g: "crippling" }] },
      { n: "Emerald Weapon", t: 5, s: "Final Fantasy VII", variants: [{ v: "underwater, on a twenty minute timer", g: "legendary" }, { v: "somebody equipped Underwater Materia", g: "weakening" }] },
      { n: "The Skeleton King", t: 3, s: "Diablo", variants: [{ v: "raising more skeletons as he goes", g: "major" }, { v: "the head is off", g: "crippling" }] },
      { n: "Diablo", t: 5, s: "Diablo Lord of Terror", variants: [{ v: "Lord of Terror, prime evil", g: "legendary" }, { v: "trapped in a soulstone", g: "crippling" }] },
      { n: "Cerberus", t: 3, s: "God of War", variants: [{ v: "three heads of ice, in the lobby", g: "major" }, { v: "the ice has been shattered", g: "weakening" }] },
      { n: "Baldur", t: 4, s: "God of War 2018", variants: [{ v: "he cannot feel anything, damage included", g: "major" }, { v: "the mistletoe arrow", g: "crippling" }] },
      { n: "Sigrun", t: 5, s: "God of War Valkyrie Queen", variants: [{ v: "every Valkyrie move, all at once", g: "legendary" }, { v: "already freed, and grateful", g: "crippling" }] },
      { n: "The Radiance", t: 5, s: "Hollow Knight", variants: [{ v: "in the dream, at full brightness", g: "legendary" }, { v: "sealed inside the Black Egg", g: "crippling" }] },
      { n: "Nightmare King Grimm", t: 5, s: "Hollow Knight", variants: [{ v: "the troupe is in town", g: "legendary" }, { v: "the Grimmchild has been banished", g: "crippling" }] },
      { n: "Hades", t: 4, f: 5, s: "Hades game boss", variants: [{ v: "second phase, and the floor is gone", g: "major" }, { v: "you have the Shield of Chaos", g: "weakening" }] },
      { n: "The Bull", t: 3, s: "Cuphead Grim Matchstick", variants: [{ v: "Asterius, with Theseus shouting", g: "major" }, { v: "Theseus is down", g: "weakening" }] },
      { n: "Dark Link", t: 3, s: "Zelda", variants: [{ v: "standing on the water", g: "major" }, { v: "he only copies what you do", g: "weakening" }] },
      { n: "Demise", t: 5, s: "Zelda Skyward Sword", variants: [{ v: "lightning drawn down the blade", g: "legendary" }, { v: "still the Imprisoned, sealed and rolling", g: "weakening" }] },
      { n: "Waluigi", t: 1, f: 1, variants: [{ v: "left out again, and furious about it", g: "major" }, { v: "not in the game", g: "crippling" }] },
      { n: "Glass Joe", t: 1, f: 1, s: "Punch-Out", variants: [{ v: "his one win in ninety-nine", g: "boon" }, { v: "his record", g: "crippling" }] },
      { n: "Wall Master", t: 1, f: 1, s: "Zelda Wallmaster", variants: [{ v: "you were not looking up", g: "legendary" }, { v: "you were looking up", g: "crippling" }] },
    ],
  },
  ...
  // ── Anime ─────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Goku", t: 5, f: 5, s: "Dragon Ball", variants: [{ v: "Ultra Instinct", g: "mythic" }, { v: "Super Saiyan", g: "boon" }, { v: "base form, kid Goku", g: "crippling" }, { v: "he has agreed to a handicap for fairness", g: "weakening" }] },
      { n: "Saitama", t: 5, f: 5, s: "One Punch Man", variants: [{ v: "serious punch", g: "mythic" }, { v: "he is going to miss the sale", g: "crippling" }, { v: "freshly woken up", g: "weakening" }] },
      { n: "Naruto Uzumaki", t: 4, f: 5, variants: [{ v: "Six Paths Sage Mode", g: "mythic" }, { v: "Sage Mode", g: "boon" }, { v: "Academy student", g: "crippling" }, { v: "out of chakra, running on shouting", g: "weakening" }] },
      { n: "Sasuke Uchiha", t: 4, f: 5, variants: [{ v: "Rinnegan open and Susanoo up", g: "legendary" }, { v: "still talking about his brother", g: "crippling" }] },
      { n: "Monkey D. Luffy", t: 4, f: 5, s: "One Piece", variants: [{ v: "Gear 5", g: "mythic" }, { v: "Gear 2", g: "boon" }, { v: "East Blue rookie", g: "crippling" }, { v: "Haki gone and a Sea Prism cuff on", g: "crippling" }] },
      { n: "Roronoa Zoro", t: 4, f: 5, s: "One Piece", variants: [{ v: "three swords, Enma drawn", g: "major" }, { v: "lost, and heading confidently the wrong way", g: "crippling" }] },
      { n: "Ichigo Kurosaki", t: 4, s: "Bleach", variants: [{ v: "True Bankai, everything unlocked", g: "legendary" }, { v: "he has lost his powers again", g: "crippling" }] },
      { n: "Levi Ackerman", t: 4, f: 5, s: "Attack on Titan", variants: [{ v: "with ODM gear", g: "major" }, { v: "no gear, open field", t: 2 }, { v: "the injured leg", g: "weakening" }] },
      { n: "Eren Yeager", t: 4, f: 5, s: "Attack on Titan", variants: [{ v: "the Founding Titan, the Rumbling started", g: "mythic" }, { v: "a boy shouting about freedom", g: "crippling" }] },
      { n: "Satoru Gojo", t: 5, f: 5, s: "Jujutsu Kaisen", variants: [{ v: "unsealed", g: "legendary" }, { v: "sealed in the box", t: 1 }, { v: "blindfold off, Six Eyes open", g: "mythic" }] },
      { n: "Tanjiro Kamado", t: 3, s: "Demon Slayer", variants: [{ v: "Sun Breathing, the full form", g: "legendary" }, { v: "carrying his sister up a hill in a box", g: "weakening" }] },
      { n: "All Might", t: 5, f: 5, s: "My Hero Academia", variants: [{ v: "prime", g: "legendary" }, { v: "post-injury, three minutes", g: "weakening" }, { v: "fifteen seconds left", g: "weakening" }] },
      { n: "Izuku Midoriya", t: 3, s: "My Hero Academia Deku", variants: [{ v: "One For All at one hundred percent", g: "legendary" }, { v: "and both arms are broken again", g: "crippling" }] },
      { n: "Vegeta", t: 5, f: 5, s: "Dragon Ball", variants: [{ v: "Ultra Ego, enjoying the damage", g: "legendary" }, { v: "Final Flash, all of it at once", g: "major" }, { v: "he has decided to explain Saiyan pride", g: "crippling" }] },
      { n: "Light Yagami", t: 2, f: 5, s: "Death Note", variants: [{ v: "with the Death Note", t: 5 }, { v: "no notebook", t: 1 }, { v: "he has just lost his temper on camera", g: "crippling" }] },
      { n: "Edward Elric", t: 3, s: "Fullmetal Alchemist", variants: [{ v: "one clap, and the ground becomes a spear", g: "major" }, { v: "somebody said the word short", g: "crippling" }] },
      { n: "Guts", t: 4, s: "Berserk", variants: [{ v: "Berserker Armor", t: 5 }, { v: "Black Swordsman", g: "major" }, { v: "he has not slept in four days", g: "weakening" }] },
      { n: "Killua Zoldyck", t: 4, s: "Hunter x Hunter", variants: [{ v: "Godspeed", g: "legendary" }, { v: "his own family conditioned him to run", g: "crippling" }] },
      { n: "Gon Freecss", t: 3, s: "Hunter x Hunter", variants: [{ v: "the adult form, everything spent at once", g: "mythic" }, { v: "asking nicely first", g: "weakening" }] },
      { n: "Meliodas", t: 5, s: "Seven Deadly Sins", variants: [{ v: "Assault Mode, demon mark spread", g: "legendary" }, { v: "his emotions have been taken", g: "weakening" }] },
      { n: "Escanor", t: 5, s: "Seven Deadly Sins", variants: [{ v: "at high noon", g: "exalted" }, { v: "at midnight", g: "crippling" }, { v: "The One, for the one minute it lasts", g: "mythic" }] },
      { n: "Yusuke Urameshi", t: 4, s: "Yu Yu Hakusho", variants: [{ v: "Mazoku, demon blood awake", g: "legendary" }, { v: "one spirit gun, and that is the lot", g: "weakening" }] },
      { n: "Spike Spiegel", t: 3, s: "Cowboy Bebop", variants: [{ v: "Jeet Kune Do and a Jericho", g: "boon" }, { v: "one eye that sees only the past", g: "weakening" }] },
      { n: "Alucard", t: 5, s: "Hellsing", variants: [{ v: "Level Zero released", g: "mythic" }, { v: "restricted to Level Three", g: "weakening" }] },
      { n: "Kenshin Himura", t: 4, s: "Rurouni Kenshin", variants: [{ v: "Battousai, reverse blade turned around", g: "legendary" }, { v: "he has sworn never to kill again", g: "weakening" }] },
      { n: "Yugi Muto", t: 1, f: 1, s: "Yu-Gi-Oh", variants: [{ v: "the Puzzle complete", g: "major" }, { v: "no deck, no Puzzle, one boy", g: "crippling" }] },
      { n: "Shinji Ikari", t: 1, s: "Evangelion", variants: [{ v: "in Eva Unit 01", t: 5 }, { v: "out of the robot", g: "crippling" }] },
      { n: "Mob", t: 5, s: "Mob Psycho 100 Shigeo Kageyama", variants: [{ v: "one hundred percent, and then something else", g: "mythic" }, { v: "trying very hard not to", g: "crippling" }] },
      { n: "Sukuna", t: 5, s: "Jujutsu Kaisen", variants: [{ v: "twenty fingers, in his own body", g: "mythic" }, { v: "one finger's worth", g: "weakening" }] },
      { n: "Yuji Itadori", t: 4, s: "Jujutsu Kaisen", variants: [{ v: "Black Flash, chained", g: "major" }, { v: "being sat on by his own body", g: "weakening" }] },
      { n: "Nobara Kugisaki", t: 3, s: "Jujutsu Kaisen", variants: [{ v: "hammer, nail and total resolve", g: "boon" }, { v: "hit in the eye", g: "crippling" }] },
      { n: "Toji Fushiguro", t: 5, s: "Jujutsu Kaisen", variants: [{ v: "the Inventory open, and no cursed energy at all", g: "legendary" }, { v: "a broke man taking a job", g: "neutral" }] },
      { n: "Zenitsu", t: 3, s: "Demon Slayer", variants: [{ v: "asleep", t: 5 }, { v: "awake and terrified", t: 1 }, { v: "awake, and hiding behind Tanjiro", g: "crippling" }] },
      { n: "Inosuke", t: 3, s: "Demon Slayer", variants: [{ v: "two blades and no sense of danger", g: "boon" }, { v: "the mask is off and he is embarrassed", g: "crippling" }] },
      { n: "Rengoku", t: 4, s: "Demon Slayer Flame Hashira", variants: [{ v: "Flame Breathing, the ninth form", g: "legendary" }, { v: "holding on until sunrise, and not making it", g: "crippling" }] },
      { n: "Muzan", t: 5, s: "Demon Slayer", variants: [{ v: "all five brains and seven hearts", g: "legendary" }, { v: "sunlight", g: "crippling" }] },
      { n: "Shanks", t: 5, s: "One Piece", variants: [{ v: "Conqueror's Haki, and the room stops", g: "legendary" }, { v: "one arm", g: "neutral" }] },
      { n: "Whitebeard", t: 5, s: "One Piece", variants: [{ v: "quaking the world, in his prime", g: "mythic" }, { v: "tubes in, on the deck, still standing", g: "weakening" }] },
      { n: "Doflamingo", t: 4, s: "One Piece", variants: [{ v: "strings on everything in the room", g: "major" }, { v: "the birdcage is up and the timer is running", g: "neutral" }] },
      { n: "Sanji", t: 4, s: "One Piece", variants: [{ v: "Diable Jambe, mid-kick", g: "major" }, { v: "there is a woman on the other side", g: "crippling" }] },
      { n: "Nami", t: 2, f: 1, s: "One Piece", variants: [{ v: "Zeus and a full Clima-Tact", g: "major" }, { v: "she has decided to hide behind somebody", g: "crippling" }] },
      { n: "Usopp", t: 2, f: 1, s: "One Piece", variants: [{ v: "God Usopp, and he believes it", g: "legendary" }, { v: "Usopp, and he does not", g: "crippling" }] },
      { n: "Kakashi", t: 4, f: 5, s: "Naruto", variants: [{ v: "with the Sharingan", t: 5 }, { v: "post-war, no Sharingan", t: 3 }, { v: "Kamui, on the eye that still works", g: "major" }] },
      { n: "Itachi Uchiha", t: 5, f: 5, s: "Naruto", variants: [{ v: "Susanoo, with the Totsuka Blade", g: "legendary" }, { v: "the illness, and blood in the cough", g: "crippling" }] },
      { n: "Madara Uchiha", t: 5, s: "Naruto", variants: [{ v: "the Ten Tails jinchuriki", g: "mythic" }, { v: "reanimated, and thoroughly enjoying himself", g: "major" }, { v: "Black Zetsu directly behind him", g: "crippling" }] },
      { n: "Rock Lee", t: 3, s: "Naruto", variants: [{ v: "eight gates open", g: "exalted" }, { v: "weights on", g: "weakening" }, { v: "he has been drinking", g: "boon" }] },
      { n: "Might Guy", t: 5, s: "Naruto", variants: [{ v: "the Eighth Gate, Night Guy", g: "mythic" }, { v: "in a wheelchair", g: "crippling" }] },
      { n: "Frieza", t: 5, f: 5, s: "Dragon Ball", variants: [{ v: "Black Frieza", g: "mythic" }, { v: "golden form, entirely untrained", g: "weakening" }, { v: "first form, being polite about it", g: "crippling" }] },
      { n: "Cell", t: 5, s: "Dragon Ball", variants: [{ v: "Perfect Cell, on a ring he built himself", g: "legendary" }, { v: "imperfect, still hunting androids", g: "crippling" }] },
      { n: "Piccolo", t: 4, s: "Dragon Ball", variants: [{ v: "Orange Piccolo", g: "legendary" }, { v: "he has just fused and needs a minute", g: "neutral" }] },
      { n: "Krillin", t: 2, f: 1, s: "Dragon Ball", variants: [{ v: "Destructo Disc, aimed at a neck", g: "major" }, { v: "targeted first, as always", g: "crippling" }] },
      { n: "Master Roshi", t: 3, s: "Dragon Ball", variants: [{ v: "Max Power, taking it seriously", g: "legendary" }, { v: "distracted by all the women", g: "crippling" }] },
      { n: "Yamcha", t: 1, f: 1, s: "Dragon Ball", variants: [{ v: "in the desert, as a bandit, at his absolute best", g: "boon" }, { v: "face down in a crater", g: "crippling" }] },
      { n: "Bardock", t: 4, s: "Dragon Ball", variants: [{ v: "seeing the future, throwing one last blast", g: "legendary" }, { v: "one man against a planet-sized ball of energy", g: "crippling" }] },
      { n: "Beerus", t: 5, s: "Dragon Ball Super", variants: [{ v: "actually trying", g: "mythic" }, { v: "asleep for the next thirty years", g: "crippling" }, { v: "there is better food elsewhere", g: "weakening" }] },
      { n: "Garou", t: 5, s: "One Punch Man", variants: [{ v: "Cosmic Fear Mode", g: "mythic" }, { v: "still a hero hunter with a hobby", g: "weakening" }] },
      { n: "Genos", t: 4, s: "One Punch Man", variants: [{ v: "freshly upgraded by the doctor", g: "major" }, { v: "in pieces, still talking", g: "crippling" }] },
      { n: "Tatsumaki", t: 5, s: "One Punch Man", variants: [{ v: "lifting the ground itself", g: "legendary" }, { v: "somebody mentioned her height", g: "crippling" }] },
      { n: "Hisoka", t: 4, s: "Hunter x Hunter", variants: [{ v: "Bungee Gum, and he is enjoying this", g: "major" }, { v: "he has decided you are not ripe yet", g: "crippling" }] },
      { n: "Meruem", t: 5, s: "Hunter x Hunter", variants: [{ v: "after En, at his full growth", g: "mythic" }, { v: "before he ever met Komugi", g: "major" }] },
      { n: "Chrollo", t: 4, s: "Hunter x Hunter", variants: [{ v: "the book open, and every stolen ability in it", g: "legendary" }, { v: "his Nen is sealed", g: "crippling" }] },
      { n: "Mikasa Ackerman", t: 4, s: "Attack on Titan", variants: [{ v: "the Ackerman awakening, blades out", g: "legendary" }, { v: "Eren said something and she froze", g: "crippling" }] },
      { n: "Armin", t: 2, s: "Attack on Titan", variants: [{ v: "Colossal Titan", t: 5 }, { v: "just Armin", t: 1 }, { v: "a plan nobody else thought of", g: "boon" }] },
      { n: "Reiner Braun", t: 4, s: "Attack on Titan", variants: [{ v: "Armored Titan, fully hardened", g: "major" }, { v: "he cannot decide who he is today", g: "crippling" }] },
      { n: "Griffith", t: 5, s: "Berserk", variants: [{ v: "reborn in flesh, the Hawk again", g: "legendary" }, { v: "a beautiful man with a sword and no Behelit", g: "weakening" }] },
      { n: "Casca", t: 3, s: "Berserk", variants: [{ v: "commanding the Hawks, before any of it", g: "boon" }, { v: "she cannot remember a single thing", g: "crippling" }] },
      { n: "Vash the Stampede", t: 4, s: "Trigun", variants: [{ v: "the angel arm", g: "legendary" }, { v: "he refuses to kill anybody", g: "weakening" }] },
      { n: "Kenshiro", t: 5, s: "Fist of the North Star", variants: [{ v: "you are already dead", g: "legendary" }, { v: "he has not found the seven scars yet", g: "neutral" }] },
      { n: "Jotaro Kujo", t: 5, s: "JoJo's Bizarre Adventure", variants: [{ v: "Star Platinum: The World, time stopped", g: "mythic" }, { v: "out of range of his own stand", g: "crippling" }] },
      { n: "Dio Brando", t: 5, s: "JoJo's Bizarre Adventure", variants: [{ v: "The World, and a steamroller", g: "mythic" }, { v: "daylight, and no Joestar body", g: "crippling" }] },
      { n: "Joseph Joestar", t: 4, s: "JoJo's Bizarre Adventure", variants: [{ v: "Hamon, and a plan he has already shouted at you", g: "major" }, { v: "old, and the Hamon is gone", g: "weakening" }] },
      { n: "Ryuk", t: 3, s: "Death Note shinigami", variants: [{ v: "bored, and finding this entertaining", g: "neutral" }, { v: "out of apples", g: "crippling" }] },
      { n: "Anya Forger", t: 1, f: 1, s: "Spy x Family", variants: [{ v: "reading every mind at the table", g: "major" }, { v: "waku waku", g: "neutral" }] },
      { n: "Chainsaw Man", t: 5, s: "Denji Chainsaw Man", variants: [{ v: "all three cords pulled", g: "legendary" }, { v: "no blood left to start the engine", g: "crippling" }] },
      { n: "Power", t: 3, s: "Chainsaw Man", variants: [{ v: "blood hammer, at full boast", g: "boon" }, { v: "she lied about all of it", g: "crippling" }] },
      { n: "Makima", t: 5, s: "Chainsaw Man", variants: [{ v: "control, and you looked her in the eye", g: "mythic" }, { v: "somebody who is not frightened of her at all", g: "crippling" }] },
      { n: "Ainz Ooal Gown", t: 5, s: "Overlord", variants: [{ v: "every cash item and world item ready", g: "legendary" }, { v: "he has no idea what he is doing and is panicking internally", g: "neutral" }] },
    ],
  },
  ...
  // ── Superheroes beyond Marvel ─────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Superman", t: 5, f: 5, variants: [{ v: "full power, yellow sun", g: "legendary" }, { v: "under a red sun", g: "crippling" }, { v: "kryptonite in the room", g: "crippling" }, { v: "magic, which nobody warned him about", g: "weakening" }] },
      { n: "Batman", t: 4, f: 5, variants: [{ v: "with prep time", t: 5 }, { v: "ambushed, no belt", t: 2 }, { v: "the Justice Buster, built for exactly this", g: "legendary" }] },
      { n: "Wonder Woman", t: 5, f: 5, variants: [{ v: "lasso out, bracers up", g: "major" }, { v: "she has promised not to kill anybody", g: "weakening" }] },
      { n: "The Flash", t: 5, f: 5, s: "Barry Allen", variants: [{ v: "Speed Force unlocked", g: "legendary" }, { v: "held to normal speed", g: "crippling" }, { v: "he stopped to save everyone else first", g: "weakening" }] },
      { n: "Green Lantern", t: 5, f: 5, s: "Hal Jordan", variants: [{ v: "ring charged", g: "major" }, { v: "ring out of power", t: 1 }, { v: "the willpower is wavering", g: "weakening" }] },
      { n: "Aquaman", t: 4, f: 5, variants: [{ v: "open water, and everything in it is listening", g: "legendary" }, { v: "in a desert, being asked about fish", g: "crippling" }] },
      { n: "Martian Manhunter", t: 5, variants: [{ v: "no fire nearby", g: "major" }, { v: "the building is on fire", t: 2 }, { v: "shapeshifted into somebody you trust", g: "major" }] },
      { n: "Cyborg", t: 4, variants: [{ v: "booyah, fully charged", g: "boon" }, { v: "out of power and back on dial-up", g: "crippling" }] },
      { n: "Shazam", t: 5, f: 5, variants: [{ v: "he has said the word", g: "legendary" }, { v: "mid-syllable, and somebody covered his mouth", g: "crippling" }] },
      { n: "Zatanna", t: 4, variants: [{ v: "speaking very clearly", g: "major" }, { v: "gagged", g: "crippling" }] },
      { n: "Constantine", t: 3, s: "John Constantine", variants: [{ v: "he set this whole thing up three days ago", g: "legendary" }, { v: "out of cigarettes and out of favours", g: "crippling" }, { v: "coughing", g: "weakening" }] },
      { n: "Doctor Fate", t: 5, variants: [{ v: "the helmet on, Nabu driving", g: "legendary" }, { v: "Kent Nelson, no helmet", g: "crippling" }] },
      { n: "Swamp Thing", t: 5, variants: [{ v: "anywhere green at all", g: "legendary" }, { v: "on concrete, in a drought", g: "crippling" }] },
      { n: "Raven", t: 4, s: "Teen Titans Raven", variants: [{ v: "letting her father through", g: "legendary" }, { v: "meditating, holding it all in", g: "weakening" }] },
      { n: "Starfire", t: 4, variants: [{ v: "starbolts, joyfully", g: "major" }, { v: "recently drained by a very long hug", g: "weakening" }] },
      { n: "Beast Boy", t: 3, variants: [{ v: "turning into a tyrannosaur", g: "major" }, { v: "turning into something small and green", g: "crippling" }] },
      { n: "Nightwing", t: 3, variants: [{ v: "escrima sticks, both hands", g: "boon" }, { v: "hit in the head again", g: "crippling" }] },
      { n: "Red Hood", t: 3, s: "Jason Todd", variants: [{ v: "guns, and no rule against using them", g: "major" }, { v: "in front of Batman", g: "weakening" }] },
      { n: "Batgirl", t: 3, s: "Barbara Gordon", variants: [{ v: "first year in the cowl", g: "boon" }, { v: "shot at her own front door", g: "crippling" }] },
      { n: "Oracle", t: 3, s: "Barbara Gordon Oracle", variants: [{ v: "the clock tower, and every camera in the city", g: "major" }, { v: "the wifi is down", g: "crippling" }] },
      { n: "Green Arrow", t: 3, variants: [{ v: "full quiver, distance kept", g: "boon" }, { v: "reaching for the boxing glove arrow", g: "crippling" }] },
      { n: "Black Canary", t: 4, variants: [{ v: "the cry, at full volume", g: "major" }, { v: "sore throat", g: "crippling" }] },
      { n: "Hawkgirl", t: 4, variants: [{ v: "Nth metal mace, coming down", g: "major" }, { v: "wings clipped, indoors", g: "weakening" }] },
      { n: "Booster Gold", t: 2, variants: [{ v: "future tech, and nobody is watching", g: "major" }, { v: "on camera, and playing to it", g: "crippling" }] },
      { n: "Blue Beetle", t: 3, variants: [{ v: "the scarab is in control", g: "legendary" }, { v: "the scarab is arguing with him", g: "weakening" }] },
      { n: "The Joker", t: 3, f: 5, variants: [{ v: "with a plan", t: 4 }, { v: "improvising", g: "boon" }, { v: "the joke did not land", g: "crippling" }] },
      { n: "Harley Quinn", t: 3, f: 5, variants: [{ v: "mallet, and no supervision", g: "major" }, { v: "waiting for a call from Mister J", g: "crippling" }] },
      { n: "Poison Ivy", t: 4, variants: [{ v: "in a greenhouse", g: "legendary" }, { v: "in a concrete parking garage", g: "crippling" }] },
      { n: "Bane", t: 4, f: 5, variants: [{ v: "on Venom", t: 5 }, { v: "tubes cut", t: 2 }, { v: "already behind you, hands on the spine", g: "major" }] },
      { n: "Scarecrow", t: 2, variants: [{ v: "the gas is already in the air", g: "major" }, { v: "somebody brought a gas mask", g: "crippling" }] },
      { n: "The Riddler", t: 2, variants: [{ v: "he riddled the whole building in advance", g: "major" }, { v: "nobody will play along", g: "crippling" }] },
      { n: "Two-Face", t: 2, variants: [{ v: "coin lands scarred", t: 3 }, { v: "coin lands clean", t: 1 }] },
      { n: "Mr. Freeze", t: 3, variants: [{ v: "suit sealed, Nora safe", g: "major" }, { v: "the suit is cracked", g: "crippling" }] },
      { n: "Clayface", t: 3, variants: [{ v: "wearing your own teammate's face", g: "major" }, { v: "somebody found the water main", g: "crippling" }] },
      { n: "Deathstroke", t: 4, variants: [{ v: "he has studied the tape", g: "legendary" }, { v: "one eye, and they went straight for it", g: "weakening" }] },
      { n: "Deadshot", t: 3, variants: [{ v: "line of sight, one bullet", g: "major" }, { v: "close quarters", g: "crippling" }] },
      { n: "Lex Luthor", t: 4, f: 5, variants: [{ v: "in the warsuit", t: 5 }, { v: "in a business suit", t: 2 }, { v: "forty minutes of villain monologue", g: "crippling" }] },
      { n: "Brainiac", t: 5, variants: [{ v: "he has already shrunk a city into a jar", g: "legendary" }, { v: "in a body that can be punched", g: "weakening" }] },
      { n: "Darkseid", t: 5, f: 5, variants: [{ v: "Omega Beams, eyes open", g: "legendary" }, { v: "an avatar, not the real one", g: "weakening" }] },
      { n: "Doomsday", t: 5, variants: [{ v: "already adapted to the way you killed him", g: "legendary" }, { v: "the first time", g: "neutral" }] },
      { n: "Black Adam", t: 5, variants: [{ v: "he has decided not to hold back", g: "legendary" }, { v: "five thousand years out of date", g: "weakening" }] },
      { n: "Sinestro", t: 5, variants: [{ v: "yellow ring, and fear everywhere", g: "major" }, { v: "on Korugar, being told what he did there", g: "weakening" }] },
      { n: "Reverse-Flash", t: 5, s: "Eobard Thawne", variants: [{ v: "he has already erased your childhood", g: "legendary" }, { v: "trapped in the Speed Force", g: "crippling" }] },
      { n: "Solomon Grundy", t: 4, variants: [{ v: "born on a Monday", g: "boon" }, { v: "died on Saturday", g: "crippling" }] },
      { n: "Killer Croc", t: 3, variants: [{ v: "down in the sewers", g: "major" }, { v: "in a dry interrogation room", g: "crippling" }] },
      { n: "Ra's al Ghul", t: 3, variants: [{ v: "fresh out of the Lazarus Pit", g: "major" }, { v: "overdue for a dip", g: "weakening" }] },
      { n: "Alfred Pennyworth", t: 2, variants: [{ v: "the shotgun, and no patience left", g: "major" }, { v: "carrying a tray", g: "neutral" }] },
      { n: "Krypto", t: 4, s: "Krypto the Superdog", variants: [{ v: "off the lead, under a yellow sun", g: "major" }, { v: "distracted by a ball", g: "crippling" }] },
      { n: "Bat-Mite", t: 1, f: 1, variants: [{ v: "reality is whatever he finds funny", g: "mythic" }, { v: "bored of you already", g: "crippling" }] },
      { n: "Matter-Eater Lad", t: 1, f: 1, variants: [{ v: "he has eaten the weapon", g: "major" }, { v: "asked to eat something enormous", g: "weakening" }] },
    ],
  },
  ...
  // ── Middle-earth ──────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Legolas", t: 4, f: 5, variants: [{ v: "counting, and ahead", g: "boon" }, { v: "riding a shield down a staircase", g: "major" }, { v: "out of arrows", g: "crippling" }] },
      { n: "Gimli", t: 4, f: 5, variants: [{ v: "nobody tosses him", g: "boon" }, { v: "tossed", g: "weakening" }, { v: "breathing so loud they can hear him in Mordor", g: "neutral" }] },
      { n: "Boromir", t: 4, f: 5, variants: [{ v: "before Amon Hen", g: "boon" }, { v: "three arrows in", t: 2 }, { v: "the horn of Gondor sounding", g: "boon" }] },
      { n: "Faramir", t: 4, variants: [{ v: "the rangers of Ithilien already in the trees", g: "major" }, { v: "riding at Osgiliath because his father said so", g: "crippling" }] },
      ...
      { n: "Éomer", t: 4, variants: [{ v: "the Rohirrim behind him at dawn", g: "legendary" }, { v: "banished, three days from anywhere", g: "weakening" }] },
      { n: "Samwise Gamgee", t: 3, f: 5, variants: [{ v: "with Sting and the Phial", t: 4 }, { v: "with a frying pan", t: 2 }, { v: "carrying Frodo up the mountain", g: "major" }] },
      { n: "Frodo", t: 2, f: 5, variants: [{ v: "wearing the Ring", t: 4 }, { v: "stung by Shelob", t: 1 }, { v: "at the Cracks of Doom, and he has changed his mind", g: "crippling" }] },
      { n: "Merry", t: 2, variants: [{ v: "the barrow-blade, behind a knee", g: "major" }, { v: "in a barrel", g: "crippling" }] },
      { n: "Pippin", t: 2, variants: [{ v: "in the livery of Gondor", g: "boon" }, { v: "second breakfast, fully fed", g: "neutral" }, { v: "he has touched the palantir", g: "crippling" }] },
      { n: "Bilbo", t: 2, variants: [{ v: "the Ring on and Sting drawn", g: "major" }, { v: "one hundred and eleven years old", g: "crippling" }] },
      { n: "Gollum", t: 2, f: 5, variants: [{ v: "Sméagol, helpful", g: "weakening" }, { v: "Gollum, at the Cracks of Doom", t: 3 }, { v: "there is a fish", g: "boon" }] },
      { n: "Galadriel", t: 5, f: 5, variants: [{ v: "she took the Ring", g: "mythic" }, { v: "all shall love me and despair", g: "legendary" }, { v: "she passed the test, and will diminish", g: "weakening" }] },
      { n: "Elrond", t: 4, variants: [{ v: "at the Last Alliance, sword drawn", g: "major" }, { v: "chairing a council", g: "crippling" }] },
      { n: "Arwen", t: 3, variants: [{ v: "at the Ford, with the river answering", g: "major" }, { v: "fading, tied to the Ring", g: "crippling" }] },
      { n: "Glorfindel", t: 5, variants: [{ v: "revealed in the light of the Blessed Realm", g: "legendary" }, { v: "he has already died to a Balrog once", g: "neutral" }] },
      { n: "Treebeard", t: 5, variants: [{ v: "the Ents roused and the dam broken", g: "legendary" }, { v: "still deciding", g: "crippling" }] },
      { n: "Tom Bombadil", t: 5, variants: [{ v: "as himself", t: 5 }, { v: "unbothered, singing", t: 5 }] },
      { n: "Beorn", t: 5, variants: [{ v: "bear form, at the Five Armies", g: "legendary" }, { v: "as a host, being polite about it", g: "weakening" }] },
      { n: "Bard the Bowman", t: 4, variants: [{ v: "the Black Arrow, and a thrush told him where", g: "legendary" }, { v: "an ordinary arrow", g: "weakening" }] },
      { n: "Thorin Oakenshield", t: 4, variants: [{ v: "Orcrist drawn, and no gold to think about", g: "major" }, { v: "dragon-sick on a pile of it", g: "crippling" }] },
      { n: "Sauron", t: 5, f: 5, variants: [{ v: "with the One Ring", g: "mythic" }, { v: "a lidless eye only", g: "weakening" }, { v: "in fair form as Annatar, and you trust him", g: "major" }] },
      { n: "The Witch-king", t: 5, variants: [{ v: "no man can kill him", g: "legendary" }, { v: "facing a woman and a hobbit", t: 3 }] },
      { n: "Saruman", t: 4, f: 5, variants: [{ v: "staff unbroken", t: 5 }, { v: "staff broken", t: 1 }, { v: "a hundred voices, all of them agreeing with him", g: "major" }] },
      { n: "A Nazgûl", t: 4, s: "Ringwraith", variants: [{ v: "on a fell beast", g: "major" }, { v: "at a running river", g: "crippling" }] },
      { n: "The Balrog", t: 5, f: 5, variants: [{ v: "whip out, on a narrow bridge", g: "legendary" }, { v: "the bridge broke under it too", g: "weakening" }] },
      { n: "Shelob", t: 4, variants: [{ v: "in her own tunnels", g: "legendary" }, { v: "the Phial of Galadriel is lit", g: "crippling" }] },
      { n: "The Mouth of Sauron", t: 2, variants: [{ v: "terms to offer, and something of yours in his hand", g: "boon" }, { v: "asked one direct question", g: "crippling" }] },
      { n: "Lurtz", t: 3, s: "Uruk-hai captain", variants: [{ v: "fresh out of the mud", g: "major" }, { v: "three arrows in, still walking", g: "neutral" }] },
      { n: "An Uruk-hai", t: 3, variants: [{ v: "a hundred of them, shields locked", g: "major" }, { v: "arguing about what is on the menu", g: "crippling" }] },
      { n: "A cave troll", t: 3, variants: [{ v: "chained, and swinging anyway", g: "boon" }, { v: "somebody has grabbed the chain", g: "crippling" }] },
      { n: "An Oliphaunt", t: 4, s: "Mumakil", variants: [{ v: "at a full charge", g: "legendary" }, { v: "one hobbit-sized arrow, one eye", g: "crippling" }] },
      { n: "A Warg", t: 3, variants: [{ v: "with a rider", g: "boon" }, { v: "its orc has fallen off", g: "weakening" }] },
      { n: "Smaug", t: 5, f: 5, variants: [{ v: "scales intact", g: "major" }, { v: "the gap in the breast", t: 3 }, { v: "talking, at great length, about himself", g: "weakening" }] },
      { n: "The Army of the Dead", t: 5, variants: [{ v: "the oath still unfulfilled", g: "legendary" }, { v: "released from the oath", g: "crippling" }] },
      { n: "Grima Wormtongue", t: 1, variants: [{ v: "whispering in exactly the right ear", g: "major" }, { v: "thrown down the stairs", g: "crippling" }] },
      { n: "Radagast", t: 3, f: 1, variants: [{ v: "every bird and beast in the wood answering", g: "major" }, { v: "mushrooms", g: "crippling" }] },
      { n: "Denethor", t: 1, f: 1, variants: [{ v: "Steward of Gondor, before the palantir", g: "boon" }, { v: "on fire, running", g: "crippling" }] },
      { n: "Barliman Butterbur", t: 1, f: 1, variants: [{ v: "he remembered the letter", g: "boon" }, { v: "he forgot the letter", g: "crippling" }] },
      { n: "The Eagles", t: 4, s: "Great Eagles Gwaihir", variants: [{ v: "arriving at the last possible second", g: "legendary" }, { v: "asked politely for a lift", g: "crippling" }] },
      ...
      { n: "Idril", t: 3, s: "Silmarillion Idril Celebrindal", variants: [{ v: "the secret way out of Gondolin already dug", g: "major" }] },
      ...
      { n: "Círdan", t: 3, s: "Silmarillion Cirdan the Shipwright", variants: [{ v: "the shipwright, with Narya still his", g: "major" }, { v: "he has given the ring away", g: "weakening" }] },
  ...
  // ── Mythology ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Zeus", t: 5, f: 5, variants: [{ v: "every other god obliged to answer him", g: "legendary" }, { v: "in the shape of a bull, mid-abduction", g: "crippling" }] },
      { n: "Odin", t: 5, f: 5, variants: [{ v: "nine nights hung, and the runes taken", g: "legendary" }, { v: "one eye, wandering about in a hat", g: "weakening" }] },
      { n: "Thor", t: 5, f: 5, s: "Norse god Thor", variants: [{ v: "with Mjölnir", g: "legendary" }, { v: "hammer stolen", t: 3 }, { v: "the belt and the iron gloves both on", g: "major" }] },
      { n: "Loki", t: 4, f: 5, s: "Norse god Loki", variants: [{ v: "shapeshifted into something you would not hit", g: "major" }, { v: "bound under a dripping serpent", g: "crippling" }] },
      { n: "Hades", t: 5, f: 5, s: "Greek god of the underworld", variants: [{ v: "on the throne of the underworld", g: "legendary" }, { v: "invited to a family dinner", g: "weakening" }] },
      { n: "Poseidon", t: 5, f: 5, variants: [{ v: "earth-shaker, and the ground has gone liquid", g: "legendary" }, { v: "in a landlocked country", g: "crippling" }] },
      { n: "Ares", t: 4, variants: [{ v: "the war itself is going his way", g: "major" }, { v: "netted with Aphrodite and laughed at", g: "crippling" }] },
      { n: "Athena", t: 5, f: 5, variants: [{ v: "she planned this three moves back", g: "legendary" }, { v: "drawn into a weaving contest", g: "weakening" }] },
      { n: "Artemis", t: 4, variants: [{ v: "the moon up and the hunt on", g: "major" }, { v: "somebody has seen her bathing", g: "neutral" }] },
      { n: "Apollo", t: 4, s: "Greek god Apollo", variants: [{ v: "prophecy and plague both to hand", g: "legendary" }, { v: "his lyre is out of tune", g: "weakening" }] },
      { n: "Hephaestus", t: 3, variants: [{ v: "he made everyone else's weapons first", g: "major" }, { v: "thrown off a mountain, again", g: "crippling" }] },
      { n: "Hermes", t: 3, variants: [{ v: "he has already stolen your side's weapons", g: "major" }, { v: "a message to deliver first", g: "weakening" }] },
      { n: "Hera", t: 4, variants: [{ v: "a grudge, and a very long memory", g: "major" }, { v: "her husband is off with somebody again", g: "weakening" }] },
      { n: "Persephone", t: 4, variants: [{ v: "half the year, on her own throne", g: "major" }, { v: "the other half, above ground and unarmed", g: "weakening" }] },
      { n: "Ra", t: 5, f: 5, s: "Egyptian sun god", variants: [{ v: "high noon, on the solar barque", g: "legendary" }, { v: "the twelfth hour of night, and Apep is waiting", g: "crippling" }] },
      { n: "Anubis", t: 4, f: 5, variants: [{ v: "the scales out, and your heart on them", g: "major" }, { v: "the feather weighed light", g: "neutral" }] },
      { n: "Set", t: 4, s: "Egyptian god Set", variants: [{ v: "the red desert, with a storm behind him", g: "major" }, { v: "entered into a boat race", g: "crippling" }] },
      { n: "Sekhmet", t: 5, variants: [{ v: "the slaughter, and nothing will stop her", g: "legendary" }, { v: "somebody dyed the beer red", g: "crippling" }] },
      { n: "Horus", t: 4, variants: [{ v: "both eyes", g: "major" }, { v: "one eye missing", g: "weakening" }] },
      { n: "Amaterasu", t: 5, variants: [{ v: "out of the cave, the sun with her", g: "legendary" }, { v: "still sulking in the cave", g: "crippling" }] },
      { n: "Susanoo", t: 5, variants: [{ v: "the Grasscutter, over an eight-headed serpent", g: "legendary" }, { v: "banished from heaven for being a nuisance", g: "weakening" }] },
      { n: "Raijin", t: 4, variants: [{ v: "on the drums, inside a thunderhead", g: "major" }, { v: "somebody covered their navel", g: "crippling" }] },
      { n: "Sun Wukong", t: 5, f: 5, s: "Monkey King", variants: [{ v: "seventy-two transformations, staff at full size", g: "legendary" }, { v: "under a mountain for five hundred years", g: "crippling" }, { v: "the headband is tightening", g: "weakening" }] },
      { n: "Guan Yu", t: 4, variants: [{ v: "the Green Dragon blade, beard oiled", g: "major" }, { v: "too honourable to actually finish it", g: "weakening" }] },
      { n: "Kali", t: 5, s: "Hindu goddess Kali", variants: [{ v: "dancing, and it is not stopping", g: "legendary" }, { v: "her husband lay down in front of her", g: "weakening" }] },
      { n: "Shiva", t: 5, variants: [{ v: "the third eye opening", g: "mythic" }, { v: "in meditation, and not to be disturbed", g: "crippling" }] },
      { n: "Hanuman", t: 5, variants: [{ v: "grown to mountain size, carrying one", g: "legendary" }, { v: "he has forgotten what he can do", g: "crippling" }] },
      { n: "Quetzalcoatl", t: 5, variants: [{ v: "the feathered serpent, in open sky", g: "legendary" }, { v: "tricked into drinking", g: "crippling" }] },
      { n: "Huitzilopochtli", t: 4, variants: [{ v: "born fully armed, at the moment of the fight", g: "major" }, { v: "waiting on somebody's sacrifice", g: "weakening" }] },
      { n: "The Morrígan", t: 4, variants: [{ v: "three crows over the field", g: "major" }, { v: "refused, and now against him", g: "weakening" }] },
      { n: "Cú Chulainn", t: 5, variants: [{ v: "in the ríastrad, warp-spasm", g: "legendary" }, { v: "bound to a standing stone", t: 3 }, { v: "the gae bolga thrown from the water", g: "legendary" }] },
      { n: "Beowulf", t: 4, variants: [{ v: "grappling bare-handed, no sword at all", g: "major" }, { v: "fifty years on, facing a dragon", g: "weakening" }] },
      { n: "Grendel", t: 4, variants: [{ v: "in Heorot, at night", g: "major" }, { v: "one arm short", g: "crippling" }] },
      { n: "Fenrir", t: 5, variants: [{ v: "unbound at Ragnarök", g: "mythic" }, { v: "chained by Gleipnir", t: 2 }, { v: "a sword jammed in his jaw", g: "weakening" }] },
      { n: "Jörmungandr", t: 5, s: "Midgard Serpent", variants: [{ v: "it has let go of its own tail", g: "legendary" }, { v: "still coiled around the world, unbothered", g: "neutral" }] },
      { n: "The Kraken", t: 4, variants: [{ v: "there is a ship to pull under", g: "major" }, { v: "released without any warning", g: "neutral" }] },
      { n: "Medusa", t: 4, f: 5, variants: [{ v: "eye contact", t: 5 }, { v: "against a polished shield", t: 2 }, { v: "everybody here is wearing a blindfold", g: "crippling" }] },
      { n: "The Minotaur", t: 4, variants: [{ v: "in the maze, and the torch went out", g: "major" }, { v: "out on an open plain", g: "weakening" }] },
      { n: "Cerberus", t: 4, s: "three headed dog mythology", variants: [{ v: "all three heads on the only door", g: "major" }, { v: "somebody brought three cakes", g: "crippling" }] },
      { n: "The Sphinx", t: 3, variants: [{ v: "a riddle nobody here has heard", g: "major" }, { v: "the answer is man, and everybody knows it", g: "crippling" }] },
      { n: "The Hydra", t: 4, variants: [{ v: "no fire in the arena", t: 5 }, { v: "someone brought a torch", t: 2 }, { v: "it has just eaten a crab", g: "boon" }] },
      { n: "Chimera", t: 4, variants: [{ v: "all three heads breathing at once", g: "major" }, { v: "somebody has a lead-tipped spear", g: "crippling" }] },
      { n: "Baba Yaga", t: 4, variants: [{ v: "the hut is up and walking", g: "major" }, { v: "the chores were all completed", g: "crippling" }] },
      { n: "Anansi", t: 3, variants: [{ v: "he has already told the story his way", g: "major" }, { v: "the story is being told about him", g: "weakening" }] },
      { n: "Coyote", t: 3, s: "trickster Coyote mythology", variants: [{ v: "the trick is already set", g: "major" }, { v: "the trick has gone wrong, as it usually does", g: "crippling" }] },
      { n: "Icarus", t: 1, f: 1, variants: [{ v: "on the way up", t: 3 }, { v: "on the way down", g: "crippling" }, { v: "somebody told him twice", g: "boon" }] },
      { n: "Sisyphus", t: 1, f: 1, variants: [{ v: "the boulder is at the top, for one moment", g: "boon" }, { v: "the boulder is at the bottom again", g: "crippling" }] },
      { n: "Narcissus", t: 1, f: 1, variants: [{ v: "somebody drained the pool", g: "boon" }, { v: "there is a puddle", g: "crippling" }] },
      { n: "Pandora", t: 2, variants: [{ v: "box closed", t: 1 }, { v: "box open", t: 5 }, { v: "hope is still in there", g: "boon" }] },
    ],
  },
  ...
  // ── Berserk ───────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      { n: "Guts", t: 5, f: 5, s: "Berserk Black Swordsman", variants: [
        ...
        { v: "the arm cannon has one shot left", g: "weakening" },
      ] },
      ...
      { n: "Skull Knight", t: 5, f: 5, s: "Berserk", variants: [
        ...
        { v: "out of Behelit-forged blades", g: "weakening" },
      ] },
      ...
      { n: "Ubik", t: 4, s: "Berserk God Hand", variants: [{ v: "whispering exactly the right doubt", g: "legendary" }, { v: "asked to fight anything himself", g: "crippling" }] },
      { n: "Conrad", t: 4, s: "Berserk God Hand", variants: [{ v: "the plague, spreading ahead of him", g: "legendary" }, { v: "out in the open, far from any city", g: "weakening" }] },
      ...
      { n: "Judeau", t: 3, s: "Berserk Band of the Hawk", variants: [{ v: "every throwing knife at once", g: "boon" }, { v: "he never says the thing he means to say", g: "weakening" }] },
      { n: "Pippin", t: 3, s: "Berserk Band of the Hawk", variants: [{ v: "the hammer, and he does not move an inch", g: "boon" }, { v: "asked to run anywhere", g: "weakening" }] },
      ...
      { n: "Corkus", t: 2, f: 1, s: "Berserk Band of the Hawk", variants: [{ v: "talking about how good he is", g: "neutral" }, { v: "the Eclipse has started", g: "crippling" }] },
      { n: "Daiba", t: 3, s: "Berserk onmyoji", variants: [{ v: "the elemental spirits summoned", g: "major" }, { v: "in a country with no water in it", g: "weakening" }] },
      { n: "Sonia", t: 2, s: "Berserk", variants: [{ v: "the vision, and Griffith is listening", g: "major" }, { v: "nobody believes the vision", g: "weakening" }] },
      { n: "Charlotte", t: 1, f: 1, s: "Berserk princess", variants: [{ v: "the whole Midland court behind her", g: "boon" }, { v: "in a besieged castle", g: "crippling" }] },
    ],
  },
  // ── Teenage Mutant Ninja Turtles ────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Casey Jones", t: 3, f: 5, s: "TMNT Casey Jones hockey mask", variants: [
        ...
        { v: "out of hockey sticks", g: "crippling" },
      ] },
      ...
      { n: "Slash", t: 4, s: "TMNT Slash snapping turtle mutant", variants: [{ v: "a mace, and no loyalty to anybody", g: "major" }, { v: "somebody took his plant", g: "crippling" }] },
      ...
      { n: "Usagi Yojimbo", t: 4, s: "Usagi Yojimbo rabbit ronin", variants: [
        ...
        { v: "politely waiting for them to draw first", g: "weakening" },
      ] },
      { n: "Tokka and Rahzar", t: 3, s: "TMNT Tokka Rahzar mutants", variants: [{ v: "both of them, in a sewer", g: "major" }, { v: "fed doughnuts", g: "crippling" }] },
      { n: "A Foot Soldier", t: 1, f: 1, s: "TMNT Foot Clan ninja soldier", variants: [
        { v: "a hundred of them", g: "major" },
        { v: "one, alone", g: "crippling" },
      ] },
      { n: "Metalhead", t: 3, s: "TMNT Metalhead robot turtle", variants: [{ v: "running Donatello's combat code", g: "major" }, { v: "running Michelangelo's", g: "crippling" }] },
      { n: "Mondo Gecko", t: 2, f: 1, s: "TMNT Mondo Gecko skateboard", variants: [{ v: "on a skateboard, downhill", g: "major" }, { v: "off the board", g: "weakening" }] },
      { n: "A Triceraton", t: 4, s: "TMNT Triceraton soldier", variants: [{ v: "full Republic armour and a rifle", g: "major" }, { v: "in Earth gravity", g: "weakening" }] },
    ],
  },
  ...
  // ── Power Rangers ───────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Zack Taylor", t: 3, s: "Power Rangers Zack Black Ranger", variants: [{ v: "the Power Axe, in cannon mode", g: "major" }, { v: "hip-hop kido, in a serious fight", g: "weakening" }] },
      { n: "Trini Kwan", t: 3, s: "Power Rangers Trini Yellow Ranger", variants: [{ v: "the Power Daggers, both hands", g: "boon" }, { v: "sent to a peace conference", g: "crippling" }] },
      ...
      { n: "Goldar", t: 4, s: "Power Rangers Goldar", variants: [
        ...
        { v: "finally given a real sword", g: "boon" },
      ] },
      { n: "Ivan Ooze", t: 5, s: "Power Rangers Ivan Ooze", variants: [
        { v: "free after six thousand years", g: "legendary" },
      ] },
      { n: "Scorpina", t: 3, s: "Power Rangers Scorpina", variants: [{ v: "the scorpion tail, grown to scale", g: "major" }, { v: "written out again with no explanation", g: "crippling" }] },
      ...
      { n: "The Thunder Megazord", t: 5, s: "Power Rangers Thunder Megazord", variants: [{ v: "the Thunder Saber, called down", g: "legendary" }, { v: "the Tigerzord is missing", g: "crippling" }] },
      { n: "Titanus", t: 4, s: "Power Rangers Titanus carrierzord", variants: [{ v: "carrying the whole Ultrazord formation", g: "legendary" }, { v: "on his own, just walking", g: "weakening" }] },
      { n: "Zordon", t: 2, s: "Power Rangers Zordon", variants: [
        { v: "the energy wave that ended it all", g: "mythic" },
        { v: "a face in a tube", g: "crippling" },
      ] },
      { n: "Alpha 5", t: 1, f: 1, s: "Power Rangers Alpha 5 robot", variants: [{ v: "the whole Command Center console", g: "boon" }, { v: "ay-yi-yi-yi-yi", g: "crippling" }] },
      ...
      { n: "Ninjor", t: 4, s: "Power Rangers Ninjor", variants: [{ v: "grown to zord size, at the temple", g: "legendary" }, { v: "back in the bottle", g: "crippling" }] },
      { n: "Andros", t: 4, s: "Power Rangers Andros Red Space Ranger", variants: [{ v: "the spiral saber, booster mode", g: "major" }, { v: "he has found out who Astronema is", g: "weakening" }] },
      { n: "Jen Scotts", t: 3, s: "Power Rangers Jen Time Force Pink", variants: [{ v: "the chrono morpher at full charge", g: "major" }, { v: "stranded outside her own century", g: "weakening" }] },
      { n: "Wes Collins", t: 3, s: "Power Rangers Wes Time Force Red", variants: [{ v: "the Red Time Force powers, properly earned", g: "major" }, { v: "his father wants him at the office", g: "crippling" }] },
      { n: "Master Vile", t: 4, s: "Power Rangers Master Vile", variants: [{ v: "he has turned time back on the rangers", g: "legendary" }, { v: "outvoted by his own family", g: "weakening" }] },
      { n: "Bulk and Skull", t: 1, f: 1, s: "Power Rangers Bulk Skull", variants: [{ v: "somehow, accidentally, in exactly the right place", g: "major" }, { v: "trying to unmask the rangers again", g: "crippling" }] },
    ],
  },
  ...
  // ── The Powerpuff Girls ─────────────────────────────
  {
    ...
    entries: [
      { n: "Blossom", t: 4, f: 5, s: "Powerpuff Girls Blossom pink", variants: [
        ...
        { v: "she has already worked out the weakness", g: "boon" },
      ] },
      ...
      { n: "Buttercup", t: 4, f: 5, s: "Powerpuff Girls Buttercup green", variants: [
        ...
        { v: "she has lost her lucky blanket", g: "crippling" },
      ] },
      ...
      { n: "Brick", t: 3, s: "Powerpuff Girls Brick Rowdyruff Boys", variants: [{ v: "all three Rowdyruff Boys together", g: "major" }, { v: "kissed", g: "crippling" }] },
      { n: "Boomer", t: 3, s: "Powerpuff Girls Boomer Rowdyruff Boys", variants: [{ v: "underestimated, as always", g: "major" }, { v: "given instructions", g: "crippling" }] },
      { n: "Butch", t: 3, s: "Powerpuff Girls Butch Rowdyruff Boys", variants: [{ v: "he has already started swinging", g: "major" }, { v: "on his own", g: "weakening" }] },
      { n: "Sedusa", t: 3, s: "Powerpuff Girls Sedusa", variants: [{ v: "the hair, all of it, at once", g: "major" }, { v: "the hair has been cut", g: "crippling" }] },
      { n: "The Gangreen Gang", t: 2, s: "Powerpuff Girls Gangreen Gang Ace", variants: [{ v: "all five of them, in the junkyard", g: "major" }, { v: "confronted by any adult at all", g: "crippling" }] },
      { n: "Professor Utonium", t: 2, s: "Powerpuff Girls Professor Utonium", variants: [
        { v: "with a fresh batch of Chemical X", g: "legendary" },
      ] },
      { n: "The Mayor", t: 1, f: 1, s: "Powerpuff Girls Mayor Townsville", variants: [{ v: "there is a pickle jar that needs opening", g: "major" }, { v: "there is not", g: "crippling" }] },
      { n: "Ms. Bellum", t: 2, s: "Powerpuff Girls Miss Sara Bellum", variants: [{ v: "she is running the entire city, as usual", g: "major" }, { v: "we never see her face", g: "neutral" }] },
      { n: "Bunny", t: 3, s: "Powerpuff Girls Bunny", variants: [
        { v: "unstable, and about to come apart", g: "crippling" },
      ] },
      { n: "The Talking Dog", t: 1, f: 1, s: "Powerpuff Girls talking dog", variants: [{ v: "he has overheard something important", g: "major" }, { v: "just a talking dog", g: "crippling" }] },
      { n: "The Amoeba Boys", t: 1, f: 1, s: "Powerpuff Girls Amoeba Boys", variants: [{ v: "they have finally committed a real crime", g: "boon" }, { v: "littering", g: "crippling" }] },
    ],
  },
  ...
  // ── Invincible ──────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Rex Splode", t: 3, s: "Invincible Rex Splode", variants: [{ v: "something to prove and a lot to detonate", g: "major" }, { v: "out of things to charge", g: "crippling" }] },
      ...
      { n: "Dupli-Kate", t: 2, s: "Invincible Dupli-Kate", variants: [{ v: "every duplicate at once", g: "major" }, { v: "down to the original", g: "crippling" }] },
      { n: "Titan", t: 3, s: "Invincible Titan rock", variants: [{ v: "the rock skin fully formed", g: "major" }, { v: "chipped, and flaking off", g: "weakening" }] },
      { n: "Angstrom Levy", t: 3, s: "Invincible Angstrom Levy", variants: [
        { v: "opening a door to somewhere worse", g: "legendary" },
      ] },
      { n: "Anissa", t: 5, s: "Invincible Anissa Viltrumite", variants: [{ v: "she has decided you are worth the trouble", g: "legendary" }, { v: "still trying to convert rather than kill", g: "weakening" }] },
      { n: "Oliver Grayson", t: 4, s: "Invincible Oliver Kid Omni-Man", variants: [{ v: "fully Viltrumite, and impatient", g: "major" }, { v: "still a child asking questions", g: "crippling" }] },
      { n: "Debbie Grayson", t: 1, f: 1, s: "Invincible Debbie Grayson", variants: [{ v: "she has already worked out what you are", g: "major" }, { v: "a bottle of wine in", g: "crippling" }] },
      { n: "Darkwing", t: 2, s: "Invincible Darkwing", variants: [{ v: "the Shadowverse, and he is already behind you", g: "major" }, { v: "left in the Shadowverse", g: "crippling" }] },
      { n: "Doc Seismic", t: 2, s: "Invincible Doc Seismic", variants: [{ v: "underground, hands flat on the rock", g: "major" }, { v: "lifted off the ground", g: "crippling" }] },
      { n: "The Mauler Twins", t: 3, s: "Invincible Mauler Twins", variants: [{ v: "both of them, and neither is the clone", g: "major" }, { v: "one left, arguing with himself", g: "weakening" }] },
      { n: "Machine Head", t: 2, f: 1, s: "Invincible Machine Head", variants: [{ v: "every enhanced in the city on his payroll", g: "major" }, { v: "in a room with somebody who can fly", g: "crippling" }] },
      { n: "Thaedus", t: 4, s: "Invincible Thaedus Viltrumite", variants: [{ v: "the Coalition fleet behind him", g: "major" }, { v: "one Viltrumite against the Empire", g: "weakening" }] },
      { n: "A Reanimen", t: 2, f: 1, s: "Invincible Reanimen GDA", variants: [{ v: "a full squad of them", g: "major" }, { v: "one, and it is still loading", g: "crippling" }] },
    ],
  },
  ...
  // ── Mortal Kombat ──────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Kitana", t: 4, f: 5, s: "Mortal Kombat Kitana fan blades", variants: [
        ...
        { v: "the fans have been taken off her", g: "weakening" },
      ] },
      { n: "Mileena", t: 4, s: "Mortal Kombat Mileena sai teeth", variants: [
        { v: "completely off the leash", g: "major" },
      ] },
      { n: "Sonya Blade", t: 3, f: 5, s: "Mortal Kombat Sonya Blade special forces", variants: [{ v: "full military kit, and a leg grab", g: "boon" }, { v: "running a personal grudge instead of the mission", g: "weakening" }] },
      { n: "Johnny Cage", t: 3, f: 5, s: "Mortal Kombat Johnny Cage", variants: [
        ...
        { v: "the sunglasses stay on", g: "boon" },
      ] },
      { n: "Jax Briggs", t: 3, s: "Mortal Kombat Jax metal arms", variants: [
        { v: "with the cybernetic arms", g: "boon" },
        { v: "the arms have been ripped off again", g: "crippling" },
      ] },
      { n: "Kung Lao", t: 4, s: "Mortal Kombat Kung Lao razor hat", variants: [
        { v: "hat spinning, at his absolute peak", g: "legendary" },
        { v: "he has stopped to gloat about the win", g: "crippling" },
      ] },
      { n: "Kano", t: 3, s: "Mortal Kombat Kano Black Dragon eye", variants: [{ v: "the eye laser and a knife in the boot", g: "major" }, { v: "he has already sold the team out", g: "crippling" }] },
      { n: "Reptile", t: 3, s: "Mortal Kombat Reptile green ninja", variants: [
        { v: "invisible, and already behind you", g: "major" },
        { v: "ordered to hold his human form", g: "weakening" },
      ] },
      { n: "Ermac", t: 4, s: "Mortal Kombat Ermac", variants: [
        { v: "many souls, one purpose", g: "major" },
        { v: "the souls are arguing", g: "weakening" },
      ] },
      { n: "Noob Saibot", t: 4, s: "Mortal Kombat Noob Saibot shadow", variants: [{ v: "the shadow clone out as well", g: "major" }, { v: "Bi-Han, before the Netherrealm got him", g: "weakening" }] },
      { n: "Smoke", t: 3, s: "Mortal Kombat Smoke cyber ninja", variants: [{ v: "teleporting freely", g: "major" }, { v: "the cybernetic version, and slower for it", g: "weakening" }] },
      { n: "Baraka", t: 3, s: "Mortal Kombat Baraka Tarkatan blades", variants: [{ v: "blades out, arms spread", g: "boon" }, { v: "leading a starving colony instead of fighting", g: "weakening" }] },
      { n: "Sindel", t: 4, s: "Mortal Kombat Sindel scream hair", variants: [
        { v: "the scream, at full volume", g: "major" },
      ] },
      { n: "Nightwolf", t: 3, s: "Mortal Kombat Nightwolf", variants: [{ v: "the spirit bow and the shoulder charge", g: "boon" }, { v: "the ancestors are not answering today", g: "weakening" }] },
      { n: "Kabal", t: 3, s: "Mortal Kombat Kabal hookswords", variants: [
        { v: "moving faster than anyone can react", g: "major" },
        { v: "the mask is off and he cannot breathe", g: "crippling" },
      ] },
      { n: "Jade", t: 3, s: "Mortal Kombat Jade staff green", variants: [{ v: "the staff, and projectiles simply stop", g: "major" }, { v: "a revenant, serving somebody else", g: "weakening" }] },
      { n: "Rain", t: 3, s: "Mortal Kombat Rain purple demigod", variants: [{ v: "half-god, and the water answers", g: "major" }, { v: "he was originally a joke about a song", g: "crippling" }] },
      { n: "Kenshi", t: 4, s: "Mortal Kombat Kenshi blind swordsman", variants: [
        { v: "with Sento, ancestors guiding the blade", g: "major" },
      ] },
      { n: "Sheeva", t: 4, s: "Mortal Kombat Sheeva Shokan", variants: [{ v: "four arms and a stomp", g: "major" }, { v: "away on a diplomatic errand", g: "weakening" }] },
      { n: "Motaro", t: 4, s: "Mortal Kombat Motaro centaur", variants: [{ v: "projectiles do not work on him at all", g: "legendary" }, { v: "standing on two legs, in the reboot", g: "crippling" }] },
      { n: "Cassie Cage", t: 3, s: "Mortal Kombat Cassie Cage", variants: [{ v: "the green glow, inherited", g: "major" }, { v: "taking a selfie", g: "crippling" }] },
      { n: "A Tarkatan foot soldier", t: 1, f: 1, s: "Mortal Kombat Tarkatan soldier", variants: [{ v: "an entire horde of them", g: "major" }, { v: "one, alone, with those teeth", g: "crippling" }] },
    ],
  },
  ...
  // ── Street Fighter ────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Guile", t: 4, f: 5, s: "Street Fighter Guile flat top", variants: [
        ...
        { v: "he has to hold back for two seconds first", g: "weakening" },
      ] },
      { n: "Zangief", t: 4, f: 5, s: "Street Fighter Zangief wrestler", variants: [
        ...
        { v: "in a freezer, wrestling a bear, for training", g: "boon" },
      ] },
      { n: "Blanka", t: 3, s: "Street Fighter Blanka green", variants: [{ v: "electricity up, in his own jungle", g: "major" }, { v: "somebody brought rubber gloves", g: "crippling" }] },
      { n: "Dhalsim", t: 4, s: "Street Fighter Dhalsim yoga", variants: [
        { v: "limbs at full stretch, nobody getting in", g: "major" },
        { v: "somebody got inside his reach", g: "crippling" },
      ] },
      ...
      { n: "Vega", t: 3, s: "Street Fighter Vega claw mask Balrog", variants: [
        ...
        { v: "the wall is too far away to jump off", g: "weakening" },
      ] },
      { n: "Balrog", t: 3, s: "Street Fighter Balrog boxer", variants: [{ v: "the dash punch, all of it", g: "major" }, { v: "he is not allowed to kick, ever", g: "weakening" }] },
      { n: "Sakura", t: 3, f: 5, s: "Street Fighter Sakura schoolgirl", variants: [{ v: "she has finally worked out her own style", g: "major" }, { v: "still copying Ryu, badly", g: "weakening" }] },
      ...
      { n: "Urien", t: 4, s: "Street Fighter Urien", variants: [{ v: "the Aegis Reflector up", g: "major" }, { v: "wearing the suit and the tie", g: "weakening" }] },
      { n: "Alex", t: 3, s: "Street Fighter Alex", variants: [{ v: "a full stun bar and a flash chop", g: "boon" }, { v: "still waiting for his own game", g: "crippling" }] },
      { n: "Q", t: 3, s: "Street Fighter Q trenchcoat", variants: [{ v: "nobody knows what he even is", g: "major" }, { v: "the mask comes off and there is nothing there", g: "neutral" }] },
      { n: "Dudley", t: 3, s: "Street Fighter Dudley boxer gentleman", variants: [{ v: "gloves on, roses thrown", g: "boon" }, { v: "his tea has gone cold", g: "crippling" }] },
      { n: "Makoto", t: 3, s: "Street Fighter Makoto karate", variants: [{ v: "one karakusa into absolutely everything", g: "major" }, { v: "the dojo has no students left", g: "weakening" }] },
      { n: "Ibuki", t: 3, s: "Street Fighter Ibuki ninja", variants: [{ v: "every kunai at once", g: "boon" }, { v: "she has homework", g: "crippling" }] },
      { n: "Elena", t: 3, s: "Street Fighter Elena capoeira", variants: [{ v: "healing in the middle of the round", g: "major" }, { v: "healing instead of ever winning", g: "crippling" }] },
      { n: "Rose", t: 3, s: "Street Fighter Rose scarf fortune", variants: [{ v: "soul power, and the scarf moving on its own", g: "major" }, { v: "she has already told you how it ends", g: "neutral" }] },
      { n: "E. Honda", t: 3, s: "Street Fighter E Honda sumo", variants: [{ v: "the hundred hand slap, in his own bathhouse", g: "major" }, { v: "out of the bath entirely", g: "weakening" }] },
      { n: "Fei Long", t: 3, s: "Street Fighter Fei Long", variants: [{ v: "the rekkaken chain, all three", g: "boon" }, { v: "contractually a completely different person now", g: "crippling" }] },
      { n: "Luke", t: 3, s: "Street Fighter Luke Sullivan", variants: [{ v: "the newest character, therefore the strongest", g: "major" }, { v: "patched", g: "crippling" }] },
  ...
  // ── Super Smash Bros. ─────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Meta Knight", t: 5, f: 5, s: "Super Smash Bros Brawl Meta Knight", variants: [
        ...
        { v: "nerfed in every game since", g: "weakening" },
      ] },
      ...
      { n: "Steve", t: 5, s: "Super Smash Bros Ultimate Steve Minecraft", variants: [
        ...
        { v: "standing on a diamond block he mined mid-match", g: "major" },
      ] },
      ...
      { n: "Samus", t: 3, s: "Super Smash Bros Samus", variants: [
        ...
        { v: "missiles only, no charge held", g: "weakening" },
      ] },
      { n: "Zero Suit Samus", t: 4, s: "Super Smash Bros Zero Suit Samus", variants: [{ v: "the boots, up-B into everything", g: "major" }, { v: "the suit came off at a bad moment", g: "weakening" }] },
      ...
      { n: "Sonic", t: 4, s: "Super Smash Bros Sonic", variants: [
        ...
        { v: "actually engaging, for once", g: "weakening" },
      ] },
      ...
      { n: "Joker", t: 5, s: "Super Smash Bros Joker Persona", variants: [
        ...
        { v: "the meter has not filled yet", g: "weakening" },
      ] },
      { n: "Ridley", t: 3, s: "Super Smash Bros Ultimate Ridley", variants: [{ v: "he finally made it in", g: "boon" }, { v: "scaled down to fit on the stage", g: "crippling" }] },
      { n: "King K. Rool", t: 3, s: "Super Smash Bros King K Rool", variants: [{ v: "the belly armour holding", g: "major" }, { v: "the crown thrown, and not coming back", g: "weakening" }] },
      ...
      { n: "Terry Bogard", t: 4, s: "Super Smash Bros Terry Bogard", variants: [{ v: "Go, at exactly the right percent", g: "legendary" }, { v: "the input did not come out", g: "crippling" }] },
      { n: "Kazuya Mishima", t: 4, s: "Super Smash Bros Kazuya", variants: [
        { v: "electric wind god fist, frame perfect", g: "legendary" },
      ] },
      { n: "Pyra and Mythra", t: 4, s: "Super Smash Bros Pyra Mythra", variants: [{ v: "swapping at exactly the right moment", g: "major" }, { v: "swapping at exactly the wrong moment", g: "crippling" }] },
      { n: "Banjo and Kazooie", t: 3, s: "Super Smash Bros Banjo Kazooie", variants: [{ v: "wonderwing, invincible and charging", g: "major" }, { v: "out of feathers", g: "crippling" }] },
      { n: "Sora", t: 3, s: "Super Smash Bros Sora Kingdom Hearts", variants: [{ v: "the hardest character to license, and worth it", g: "boon" }, { v: "the floatiest thing on the roster", g: "weakening" }] },
  ...
  // ── The Vampire Diaries ───────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Rebekah Mikaelson", t: 4, f: 4, variants: [{ v: "a thousand years of practice and nothing to lose", g: "major" }, { v: "she has fallen in love again", g: "crippling" }] },
      { n: "Kol Mikaelson", t: 4, f: 3, variants: [{ v: "witch again, and furious", g: "major" }] },
      { n: "Finn Mikaelson", t: 3, f: 2, variants: [{ v: "the linking spell is holding", g: "major" }, { v: "nine hundred years in a box, badly out of practice", g: "crippling" }] },
      ...
      { n: "Silas", t: 5, f: 3, variants: [{ v: "in your head, wearing your face", g: "legendary" }, { v: "desiccated into a statue", g: "crippling" }] },
      { n: "Qetsiyah", t: 4, f: 2, variants: [{ v: "two thousand years of spite, fully prepared", g: "legendary" }, { v: "the borrowed body is dying as she stands", g: "crippling" }] },
      { n: "Marcel Gerard", t: 3, f: 4, variants: [
        { v: "the Beast, after the serum", g: "legendary" },
        { v: "human again", g: "crippling" },
        { v: "the king of New Orleans, and the city agrees", g: "major" },
      ] },
      { n: "Lucien Castle", t: 4, f: 2, s: "the first Upgraded Original", variants: [{ v: "the first sire line, upgraded past the Originals", g: "legendary" }, { v: "running errands for Klaus again", g: "crippling" }] },
      ...
      { n: "Enzo St. John", t: 3, f: 3, variants: [{ v: "a century of Augustine and no mercy left", g: "major" }, { v: "compelled by somebody else", g: "crippling" }] },
      { n: "Jeremy Gilbert", t: 2, f: 3, variants: [{ v: "hunter's mark complete", g: "major" }] },
      { n: "The Hollow", t: 5, f: 2, s: "Inadu Vampire Diaries", variants: [{ v: "all four pieces reunited", g: "legendary" }, { v: "split into four and scattered", g: "crippling" }] },
      { n: "Malivore", t: 5, f: 1, s: "Legacies Malivore", variants: [{ v: "everything it swallows is forgotten", g: "legendary" }, { v: "the pit is sealed", g: "crippling" }] },
      { n: "Josie Saltzman", t: 3, f: 2, variants: [{ v: "Dark Josie, fully merged", g: "legendary" }] },
      { n: "Lizzie Saltzman", t: 3, f: 2, variants: [{ v: "siphoning, and completely unhinged", g: "major" }, { v: "mid-anxiety spiral", g: "crippling" }] },
      { n: "Rayna Cruz", t: 4, f: 2, variants: [{ v: "with the Phoenix Sword", g: "legendary" }] },
      { n: "Papa Tunde", t: 3, f: 2, variants: [{ v: "with the blade", g: "major" }] },
      { n: "Aurora de Martel", t: 3, f: 2, variants: [{ v: "off her medication and delighted about it", g: "major" }, { v: "bricked into a wall by Rebekah", g: "crippling" }] },
      { n: "Tristan de Martel", t: 3, f: 2, variants: [{ v: "the Strix standing behind him", g: "major" }, { v: "in a box at the bottom of the ocean", g: "crippling" }] },
      { n: "Vincent Griffith", t: 3, f: 2, variants: [{ v: "Regent of all nine covens", g: "major" }, { v: "he has sworn off magic again", g: "crippling" }] },
      { n: "Lily Salvatore", t: 3, f: 2, variants: [{ v: "the Heretics at her back", g: "major" }, { v: "ripper hunger, in a cage", g: "crippling" }] },
      { n: "Julian", t: 3, f: 1 },
      { n: "Nora Hildegard", t: 3, f: 1, variants: [{ v: "witch and vampire both, unleashed", g: "major" }, { v: "separated from Mary Louise", g: "weakening" }] },
      { n: "Mary Louise", t: 3, f: 1 },
      { n: "Beau", t: 3, f: 1 },
      { n: "Lexi Branson", t: 3, f: 2, variants: [{ v: "five hundred years, and she taught Stefan", g: "major" }, { v: "staked at a party", g: "crippling" }] },
      { n: "Sage", t: 3, f: 1, variants: [{ v: "she taught Damon everything he knows", g: "major" }, { v: "the sire line has collapsed under her", g: "crippling" }] },
      { n: "Rose", t: 3, f: 2 },
      { n: "Trevor", t: 2, f: 1 },
      { n: "Mason Lockwood", t: 2, f: 2, variants: [{ v: "full moon, and he has learned control", g: "major" }, { v: "chained in a cellar", g: "crippling" }] },
      { n: "Jules", t: 2, f: 1 },
      { n: "Anna", t: 2, f: 1 },
      { n: "Pearl", t: 2, f: 1 },
      { n: "Nadia Petrova", t: 3, f: 1, variants: [{ v: "five hundred years of looking for her mother", g: "boon" }, { v: "an untreated werewolf bite", g: "crippling" }] },
      { n: "Liv Parker", t: 3, f: 1 },
      { n: "Luke Parker", t: 3, f: 1 },
      { n: "Joshua Parker", t: 3, f: 1 },
      { n: "Josh Rosza", t: 2, f: 2 },
      { n: "Ansel", t: 3, f: 1 },
      { n: "Matt Donovan", t: 1, f: 4, variants: [{ v: "the only human who has survived all of it", g: "boon" }, { v: "being used as a distraction again", g: "crippling" }] },
      { n: "Jenna Sommers", t: 1, f: 2 },
      { n: "Sheriff Liz Forbes", t: 1, f: 2 },
      { n: "Camille O'Connell", t: 1, f: 2 },
      { n: "Vicki Donovan", t: 2, f: 1 },
      { n: "Amara", t: 2, f: 1, variants: [{ v: "the anchor to the other side", g: "major" }, { v: "two thousand years of standing perfectly still", g: "crippling" }] },
      { n: "Landon Kirby", t: 2, f: 1, variants: [{ v: "the phoenix, getting up again", g: "major" }, { v: "a boy who stole a knife", g: "crippling" }] },
  ...
  // ── X-Men ─────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Nightcrawler", t: 3, f: 4, variants: [{ v: "teleporting away with somebody's ankle", g: "major" }, { v: "in a room warded against teleporting", g: "crippling" }] },
      ...
      { n: "Beast", s: "Hank McCoy", t: 3, f: 4, variants: [{ v: "blue fur and six doctorates", g: "boon" }, { v: "mid-secondary-mutation, unstable", g: "crippling" }] },
      ...
      { n: "Cable", t: 4, f: 4, variants: [{ v: "techno-organic virus contained", g: "major" }, { v: "out of bullets and out of time", g: "weakening" }] },
      { n: "Deadpool", t: 3, f: 5 },
      { n: "Bishop", t: 3, f: 3, variants: [{ v: "he has absorbed the last three attacks", g: "major" }, { v: "nobody here is shooting energy at him", g: "weakening" }] },
      { n: "Apocalypse", t: 5, f: 5, variants: [
        { v: "with all four Horsemen", g: "legendary" },
        { v: "mid-regeneration, out of the pod", g: "weakening" },
      ] },
      { n: "Mister Sinister", t: 4, f: 3, variants: [{ v: "the whole Essex diary, and a plan out of it", g: "legendary" }, { v: "outmanoeuvred by a Summers", g: "weakening" }] },
      { n: "Sabretooth", t: 4, f: 4, variants: [{ v: "he has picked up the scent", g: "major" }, { v: "declawed, and on trial on Krakoa", g: "crippling" }] },
      { n: "Juggernaut", t: 5, f: 4, variants: [
        { v: "at full momentum, unstoppable", g: "legendary" },
        { v: "helmet off", g: "weakening" },
      ] },
      { n: "Mystique", t: 3, f: 4, variants: [{ v: "wearing your leader's face", g: "major" }, { v: "her real face, in a room of telepaths", g: "weakening" }] },
      ...
      { n: "Proteus", t: 5, f: 2, variants: [{ v: "in a host body that will hold", g: "legendary" }, { v: "the host body is burning out", g: "crippling" }] },
      { n: "Nate Grey", s: "X-Man", t: 5, f: 2, variants: [{ v: "the Shaman, remaking the world to suit himself", g: "mythic" }, { v: "the psionics are burning him out", g: "crippling" }] },
      { n: "Vulcan", t: 5, f: 1, variants: [{ v: "he has eaten a star's worth of energy", g: "legendary" }, { v: "lost in the Fault", g: "crippling" }] },
      { n: "Exodus", t: 4, f: 1, variants: [{ v: "acting on behalf of Magneto, devoutly", g: "major" }, { v: "asked to think for himself", g: "weakening" }] },
      { n: "Archangel", t: 3, f: 3, variants: [{ v: "Horseman of Death, metal wings", g: "legendary" }, { v: "Warren, refusing to let Death out", g: "weakening" }] },
      { n: "Havok", t: 4, f: 3, variants: [{ v: "the plasma, tightly focused", g: "major" }, { v: "standing directly in front of Cyclops", g: "crippling" }] },
      { n: "Polaris", t: 4, f: 3, variants: [{ v: "there is metal everywhere in here", g: "major" }, { v: "off her medication", g: "weakening" }] },
      { n: "Quicksilver", t: 4, f: 4, variants: [{ v: "the whole room in one second, to a good song", g: "legendary" }, { v: "he has broken both legs again", g: "crippling" }] },
      { n: "X-23", s: "Laura Kinney", t: 4, f: 4, variants: [{ v: "the trigger scent is in the air", g: "major" }, { v: "the foot claws are out and she is barefoot", g: "boon" }] },
      { n: "Hope Summers", t: 4, f: 2, variants: [{ v: "mimicking five mutants at once", g: "major" }, { v: "no other mutants anywhere near her", g: "crippling" }] },
      { n: "Jubilee", t: 2, f: 3, variants: [{ v: "the fireworks, at very close range", g: "boon" }, { v: "the fireworks, which are fireworks", g: "crippling" }] },
      { n: "Banshee", t: 3, f: 2, variants: [{ v: "the scream at full pitch", g: "major" }, { v: "the throat injury", g: "crippling" }] },
      ...
      { n: "Wolfsbane", t: 2, f: 2 },
      { n: "Forge", t: 2, f: 2, variants: [{ v: "given a workshop and an afternoon", g: "legendary" }, { v: "given absolutely nothing to work with", g: "crippling" }] },
      { n: "Dazzler", t: 3, f: 2, variants: [{ v: "a stadium concert going on behind her", g: "legendary" }, { v: "a quiet library", g: "crippling" }] },
      { n: "Longshot", t: 3, f: 1 },
      { n: "Multiple Man", t: 3, f: 2, variants: [{ v: "a thousand duplicates", g: "major" }, { v: "one dupe, and it is the anxious one", g: "crippling" }] },
      { n: "Northstar", t: 3, f: 2 },
      { n: "Sunfire", t: 3, f: 2 },
      { n: "Blink", t: 3, f: 2 },
      { n: "Warpath", t: 3, f: 1 },
      ...
      { n: "Husk", t: 2, f: 1 },
      { n: "Marrow", t: 2, f: 1 },
      { n: "Omega Red", t: 4, f: 2, variants: [{ v: "the carbonadium coils out", g: "major" }, { v: "he badly needs a death spore fix", g: "weakening" }] },
      { n: "Lady Deathstrike", t: 3, f: 2, variants: [{ v: "the adamantium talons extended", g: "major" }, { v: "her programming has been overwritten", g: "crippling" }] },
      { n: "Silver Samurai", t: 3, f: 1 },
      { n: "Shadow King", t: 4, f: 2, variants: [{ v: "on the astral plane", g: "legendary" }, { v: "dragged down into a physical body", g: "crippling" }] },
      { n: "Selene", t: 4, f: 1 },
      { n: "Sebastian Shaw", t: 4, f: 2, variants: [{ v: "already absorbed a great deal", g: "major" }] },
      { n: "Stryfe", t: 4, f: 2 },
      { n: "Bastion", t: 4, f: 2 },
      { n: "Nimrod", t: 5, f: 2, variants: [{ v: "already adapted, and from the future", g: "legendary" }, { v: "freshly arrived, with no data yet", g: "weakening" }] },
      { n: "Master Mold", t: 4, f: 1, variants: [{ v: "building more Sentinels as it fights", g: "legendary" }, { v: "bolted to a factory floor", g: "weakening" }] },
      { n: "A Sentinel", t: 3, f: 3, s: "X-Men Sentinel robot" },
      { n: "Pyro", t: 3, f: 2, variants: [{ v: "there is already a fire going", g: "major" }, { v: "he cannot make a flame himself", g: "crippling" }] },
      { n: "Avalanche", t: 3, f: 2, variants: [{ v: "standing on unstable ground", g: "major" }, { v: "standing on a steel deck", g: "weakening" }] },
      { n: "The Blob", t: 3, f: 2, variants: [{ v: "nobody moves the Blob", g: "major" }, { v: "somebody moved the Blob", g: "crippling" }] },
      { n: "Toad", t: 2, f: 2, variants: [{ v: "the tongue, and a surprising amount of leaping", g: "boon" }, { v: "struck by lightning", g: "crippling" }] },
      { n: "Mojo", t: 3, f: 1, variants: [{ v: "the ratings are up", g: "major" }, { v: "cancelled", g: "crippling" }] },
      { n: "Spiral", t: 3, f: 1, variants: [{ v: "six arms, six swords", g: "major" }, { v: "the dance is not finished", g: "weakening" }] },
      { n: "Dark Beast", t: 3, f: 1, variants: [{ v: "out of the Age of Apocalypse, with notes", g: "major" }, { v: "mistaken for the real one", g: "neutral" }] },
      { n: "Moira MacTaggert", t: 2, f: 2, variants: [{ v: "she has already lived this life nine times", g: "legendary" }, { v: "first life, an ordinary scientist", g: "crippling" }] },
      { n: "Gorgon", t: 3, f: 1, variants: [{ v: "the Godkiller, eyes open", g: "major" }, { v: "resurrected badly", g: "weakening" }] },
    ],
  },
  ...
  // ── Godzilla ──────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Rodan", t: 4, f: 4, variants: [{ v: "Fire Rodan", g: "legendary" }, { v: "grounded, wings pinned", g: "crippling" }] },
      ...
      { n: "Gigan", t: 4, f: 3, variants: [{ v: "chainsaw hands", g: "major" }, { v: "the buzzsaw has jammed", g: "crippling" }] },
      { n: "Hedorah", t: 4, f: 3, variants: [{ v: "flying form, over a city", g: "major" }] },
      { n: "Monster X", t: 5, f: 2, variants: [{ v: "Keizer Ghidorah", g: "legendary" }] },
      { n: "Orga", t: 4, f: 2, variants: [{ v: "mid-swallow, absorbing Godzilla", g: "legendary" }, { v: "the shoulder cannon is out", g: "weakening" }] },
      { n: "Megaguirus", t: 4, f: 2, variants: [{ v: "the swarm still alive around her", g: "major" }, { v: "the swarm is gone", g: "weakening" }] },
      { n: "Battra", t: 4, f: 2, variants: [{ v: "the larval form, tunnelling up", g: "major" }, { v: "flying, and in Mothra's way", g: "weakening" }] },
      { n: "Anguirus", t: 3, f: 3, variants: [{ v: "curled up and rolling", g: "major" }, { v: "flipped onto his back", g: "crippling" }] },
      { n: "King Caesar", t: 3, f: 2, variants: [{ v: "the mirror is angled, reflecting the beam", g: "major" }, { v: "still asleep inside the mountain", g: "crippling" }] },
      { n: "Jet Jaguar", t: 3, f: 2, variants: [{ v: "grown to kaiju scale", g: "legendary" }] },
      { n: "Megalon", t: 3, f: 2, variants: [{ v: "with Gigan alongside him", g: "major" }, { v: "drilling into concrete instead", g: "weakening" }] },
      { n: "Titanosaurus", t: 3, f: 2, variants: [{ v: "the tail fan at full blast", g: "major" }, { v: "the sonic wave device is switched on", g: "crippling" }] },
      { n: "Baragon", t: 3, f: 2, variants: [{ v: "burrowing up underneath", g: "major" }, { v: "blamed for something Godzilla did", g: "neutral" }] },
      { n: "Varan", t: 3, f: 1, variants: [{ v: "gliding", g: "major" }, { v: "on the ground", g: "weakening" }] },
      { n: "Manda", t: 2, f: 1, variants: [{ v: "coiled around a submarine", g: "major" }, { v: "out of the water entirely", g: "crippling" }] },
      { n: "Kumonga", t: 3, f: 2, variants: [{ v: "the webbing already laid", g: "major" }, { v: "the webbing burned off", g: "weakening" }] },
      { n: "Kamacuras", t: 2, f: 2, variants: [{ v: "a whole swarm of them", g: "major" }, { v: "one, and it is hungry", g: "weakening" }] },
      { n: "Ebirah", t: 3, f: 2, variants: [{ v: "deep water, claw first", g: "major" }, { v: "hauled up onto a beach", g: "crippling" }] },
      { n: "Gorosaurus", t: 3, f: 1, variants: [{ v: "the kangaroo kick", g: "major" }, { v: "retired on Monster Island", g: "weakening" }] },
      { n: "Gabara", t: 2, f: 1, variants: [{ v: "picking on something smaller", g: "boon" }, { v: "something bigger has turned up", g: "crippling" }] },
      { n: "Minilla", t: 1, f: 2, variants: [{ v: "dad is watching", g: "major" }, { v: "blowing smoke rings", g: "crippling" }] },
      { n: "Godzilla Junior", t: 3, f: 2, variants: [{ v: "grown, and defending the nest", g: "major" }, { v: "still in the egg", g: "crippling" }] },
      { n: "Zilla", t: 3, f: 2, s: "Godzilla 1998", variants: [{ v: "in a tunnel, in New York", g: "boon" }, { v: "three missiles", g: "crippling" }] },
      { n: "Mechani-Kong", t: 3, f: 1, variants: [{ v: "the wrecking ball out", g: "major" }, { v: "the electric halo has shorted", g: "weakening" }] },
      { n: "Skullcrawler", t: 3, f: 3, variants: [{ v: "a whole nest of them", g: "major" }, { v: "one, and the tongue is already out", g: "weakening" }] },
      { n: "The Skull Devil", t: 4, f: 2, variants: [{ v: "in the pit, on its own island", g: "major" }, { v: "a chain around the neck", g: "crippling" }] },
      { n: "Behemoth", t: 4, f: 2, variants: [{ v: "in the forest, tusks down", g: "major" }, { v: "asleep for a thousand years", g: "weakening" }] },
      { n: "Scylla", t: 3, f: 2, variants: [{ v: "in the water, all eight legs working", g: "major" }, { v: "on land, in a sandstorm", g: "weakening" }] },
      { n: "Methuselah", t: 4, f: 1, variants: [{ v: "risen, with a mountain still on his back", g: "major" }, { v: "mistaken for terrain and slept through it", g: "crippling" }] },
      { n: "Queen MUTO", t: 4, f: 3, variants: [{ v: "the nest is full of eggs", g: "major" }, { v: "the eggs have been burned", g: "crippling" }] },
      { n: "MUTO Prime", t: 4, f: 2, variants: [{ v: "hunting a Titan to lay in", g: "major" }, { v: "already spent from laying", g: "weakening" }] },
      { n: "Warbat", t: 3, f: 1, variants: [{ v: "coiled in flight", g: "major" }, { v: "grounded", g: "crippling" }] },
      { n: "Tiamat", t: 4, f: 1, s: "Godzilla Titanus Tiamat", variants: [{ v: "in the Hollow Earth, on her own territory", g: "major" }, { v: "a long way from the ice", g: "weakening" }] },
      { n: "Shimo", t: 4, f: 2, variants: [{ v: "the freeze breath, unrestrained", g: "legendary" }, { v: "the Scar King has the crystal", g: "crippling" }] },
      { n: "The Scar King", t: 4, f: 2, variants: [{ v: "the crystal in hand and Shimo obeying", g: "legendary" }, { v: "the crystal broken", g: "crippling" }] },
      { n: "Dagon", t: 4, f: 1, variants: [{ v: "before Kong ever got to him", g: "major" }, { v: "already beaten by a younger Kong", g: "crippling" }] },
      { n: "Bagan", t: 5, f: 1, variants: [{ v: "the one they never actually made", g: "legendary" }, { v: "still just concept art", g: "crippling" }] },
      { n: "Godzilla Ultima", t: 5, f: 1, variants: [{ v: "past the singularity, still scaling", g: "mythic" }, { v: "before it starts scaling at all", g: "weakening" }] },
    ],
  },
  ...
  // ── Yu-Gi-Oh! ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Zorc Necrophades", t: 5, f: 2, variants: [{ v: "the Shadow Game has already begun", g: "legendary" }, { v: "the name has been spoken aloud", g: "crippling" }] },
      { n: "Mai Valentine", t: 3, f: 3, variants: [{ v: "she has memorised the scent of every card", g: "major" }, { v: "the Shadow Realm is eating her memory", g: "crippling" }] },
      { n: "Ishizu Ishtar", t: 2, f: 2 },
      { n: "Bandit Keith", t: 2, f: 2, variants: [{ v: "a card up his sleeve, literally", g: "major" }] },
      { n: "Mako Tsunami", t: 2, f: 2, variants: [{ v: "a water field and a very large fish", g: "major" }, { v: "on dry land, talking about the sea", g: "crippling" }] },
      { n: "Duke Devlin", t: 2, f: 2 },
      { n: "Rebecca Hawkins", t: 2, f: 1 },
      { n: "Weevil Underwood", t: 1, f: 2, variants: [{ v: "he threw your best card off a boat first", g: "major" }, { v: "in an actual duel", g: "crippling" }] },
      { n: "Rex Raptor", t: 1, f: 2, variants: [{ v: "an entire deck of dinosaurs", g: "boon" }, { v: "he lost the deck in a bet", g: "crippling" }] },
      { n: "Tea Gardner", t: 1, f: 2, variants: [{ v: "a speech about friendship, mid-duel", g: "boon" }, { v: "actually duelling", g: "crippling" }] },
      { n: "Tristan Taylor", t: 1, f: 2, variants: [{ v: "he has picked somebody up and is running", g: "boon" }, { v: "his voice changed between seasons", g: "neutral" }] },
      { n: "Jaden Yuki", t: 4, f: 4, variants: [{ v: "the Supreme King", g: "legendary" }] },
      { n: "Yubel", t: 4, f: 2, variants: [{ v: "all three forms, fused into one", g: "legendary" }, { v: "sealed inside a satellite", g: "crippling" }] },
      { n: "Zane Truesdale", t: 4, f: 2, variants: [{ v: "Hell Kaiser, underground duelling", g: "major" }] },
      { n: "Chazz Princeton", t: 3, f: 2, variants: [{ v: "the Ojama brothers, unfortunately", g: "major" }, { v: "Chazz it up", g: "neutral" }] },
      ...
      { n: "Jack Atlas", t: 4, f: 3, variants: [{ v: "the King, on the D-Wheel", g: "major" }, { v: "his coffee has gone cold", g: "weakening" }] },
      { n: "Crow Hogan", t: 3, f: 2, variants: [{ v: "the whole Blackwing swarm out", g: "major" }, { v: "one Blackwing", g: "weakening" }] },
      { n: "Akiza Izinski", t: 3, f: 2, variants: [{ v: "psychic duelist, damage is real", g: "major" }] },
      { n: "Kalin Kessler", t: 3, f: 2 },
      { n: "Z-one", t: 5, f: 1, variants: [{ v: "the Timelords, every one of them", g: "legendary" }, { v: "the machine body is failing", g: "crippling" }] },
      { n: "Yuma Tsukumo", t: 3, f: 3 },
      { n: "Astral", t: 4, f: 2, variants: [{ v: "all one hundred Numbers recovered", g: "legendary" }, { v: "fading, with memories missing", g: "crippling" }] },
      { n: "Vector", t: 4, f: 2 },
      { n: "Don Thousand", t: 5, f: 1, variants: [{ v: "the whole Barian world behind him", g: "legendary" }, { v: "sealed for another thousand years", g: "crippling" }] },
      { n: "Yuya Sakaki", t: 3, f: 3 },
      { n: "Declan Akaba", t: 4, f: 2, variants: [{ v: "the D/D/D deck fully assembled", g: "major" }, { v: "outdrawn on turn one", g: "crippling" }] },
      ...
      { n: "Summoned Skull", t: 3, f: 3, variants: [{ v: "the field spell is already up", g: "major" }, { v: "no tribute available", g: "crippling" }] },
      ...
      { n: "Five-Headed Dragon", t: 5, f: 2, variants: [{ v: "all five attributes covered", g: "legendary" }, { v: "somebody has a light attribute monster", g: "crippling" }] },
      { n: "Gate Guardian", t: 4, f: 2, variants: [{ v: "all three tributes on the field", g: "legendary" }, { v: "two of the three, and no third", g: "crippling" }] },
      ...
      { n: "Winged Kuriboh", t: 1, f: 2, variants: [{ v: "level ten", g: "major" }, { v: "level one", g: "crippling" }] },
      { n: "Time Wizard", t: 2, f: 3, variants: [
        { v: "the roulette landed", g: "legendary" },
        { v: "the roulette did not", g: "crippling" },
      ] },
      { n: "Copycat", t: 2, f: 1 },
      { n: "Mystical Elf", t: 2, f: 2, variants: [{ v: "in defence position, wall mode", g: "boon" }, { v: "asked to attack", g: "crippling" }] },
      { n: "Celtic Guardian", t: 2, f: 2, variants: [{ v: "nothing above fifteen hundred can touch him", g: "major" }, { v: "somebody actually read the card", g: "crippling" }] },
      { n: "Baby Dragon", t: 1, f: 2, variants: [{ v: "the Time Wizard is on the field", g: "legendary" }, { v: "no Time Wizard anywhere", g: "crippling" }] },
      { n: "Blue-Eyes Toon Dragon", t: 3, f: 2, variants: [{ v: "Toon World is up", g: "major" }, { v: "somebody destroyed Toon World", g: "crippling" }] },
      { n: "Obnoxious Celtic Guard", t: 2, f: 1 },
      { n: "Slime Token", t: 1, f: 1, variants: [{ v: "an entire wall of them", g: "boon" }, { v: "one slime token", g: "crippling" }] },
    ],
  },
  ...
  // ── The CW ────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Kara Zor-El", t: 5, f: 5, s: "Supergirl CW", variants: [{ v: "solar flared, powers spent", g: "crippling" }, { v: "the full solar charge, and she is angry", g: "legendary" }], wiki: "arrow" },
      { n: "General Zod", t: 5, f: 3, s: "Smallville Zod", wiki: "smallville", variants: [{ v: "the Phantom Zone open, army coming through", g: "legendary" }, { v: "still in the Zone, shouting", g: "crippling" }] },
      { n: "Doomsday", t: 5, f: 3, s: "Smallville Doomsday Davis Bloome", wiki: "smallville", variants: [{ v: "unleashed out of Clark entirely", g: "legendary" }, { v: "still buried in the ice", g: "crippling" }] },
      { n: "Brainiac", t: 5, f: 3, s: "Smallville Brainiac", wiki: "smallville", variants: [{ v: "wearing somebody's best friend's face", g: "major" }, { v: "reduced to a laptop", g: "crippling" }] },
      { n: "Bizarro", t: 5, f: 2, s: "Smallville Bizarro", wiki: "smallville", variants: [{ v: "standing in a blue sun", g: "major" }, { v: "under a yellow sun, burning", g: "crippling" }] },
      { n: "Martian Manhunter", t: 5, f: 3, s: "Smallville Martian Manhunter", wiki: "smallville", variants: [{ v: "out in the open, full Martian mind", g: "major" }, { v: "something in the building is on fire", g: "crippling" }] },
      { n: "Lex Luthor", t: 3, f: 5, s: "Smallville Lex Luthor", wiki: "smallville", variants: [{ v: "the kryptonite and the corporation both", g: "major" }, { v: "his memory has been wiped again", g: "crippling" }] },
      { n: "Lionel Luthor", t: 2, f: 2, wiki: "smallville" },
      { n: "Chloe Sullivan", t: 2, f: 3, wiki: "smallville", variants: [{ v: "Watchtower, every system online", g: "major" }, { v: "her healing power just cost her a life", g: "crippling" }] },
      ...
      { n: "Barry Allen", t: 5, f: 5, s: "The Flash CW Barry Allen", variants: [
        ...
        { v: "he has to explain the plan to the team first", g: "weakening" },
      ] },
      { n: "Eobard Thawne", t: 5, f: 4, s: "Reverse Flash", variants: [{ v: "negative Speed Force", g: "legendary" }], wiki: "arrow" },
      { n: "Zoom", t: 5, f: 3, s: "The Flash Hunter Zolomon Zoom", wiki: "arrow", variants: [{ v: "the time remnant plan already in motion", g: "legendary" }, { v: "slowed by his own decay", g: "weakening" }] },
      { n: "Savitar", t: 5, f: 3, wiki: "arrow", variants: [{ v: "out of the Speed Force, armour on", g: "legendary" }, { v: "back in the Speed Force prison", g: "crippling" }] },
      { n: "Godspeed", t: 4, f: 2, wiki: "arrow", variants: [{ v: "a dozen copies of himself", g: "major" }, { v: "one copy, and it needs recharging", g: "weakening" }] },
      { n: "The Black Flash", t: 5, f: 1, wiki: "arrow", variants: [{ v: "sent after somebody specific", g: "legendary" }, { v: "given no target at all", g: "crippling" }] },
      { n: "Wally West", t: 4, f: 3, s: "Kid Flash CW", wiki: "arrow" },
      { n: "Jesse Quick", t: 4, f: 2, wiki: "arrow" },
      { n: "Jay Garrick", t: 4, f: 2, wiki: "arrow" },
      { n: "Killer Frost", t: 4, f: 4, s: "The Flash Killer Frost Caitlin Snow", wiki: "arrow", variants: [{ v: "no Caitlin in there at all", g: "major" }, { v: "Caitlin is driving", g: "weakening" }] },
      { n: "Vibe", t: 3, f: 3, s: "The Flash Cisco Ramon Vibe", wiki: "arrow" },
      { n: "Gorilla Grodd", t: 4, f: 3, wiki: "arrow", variants: [{ v: "in your head before he is in the room", g: "legendary" }, { v: "in the cold-fusion cage", g: "crippling" }] },
      { n: "Captain Cold", t: 3, f: 4, s: "Leonard Snart CW", wiki: "arrow", variants: [{ v: "the cold gun, and an actual code", g: "major" }, { v: "the gun has been taken apart", g: "crippling" }] },
      ...
      { n: "Oliver Queen", t: 3, f: 5, s: "Arrow Green Arrow", variants: [
        ...
        { v: "out of arrows, out of allies", g: "crippling" },
      ] },
      { n: "John Diggle", t: 2, f: 4, wiki: "arrow" },
      { n: "Felicity Smoak", t: 1, f: 4, wiki: "arrow", variants: [{ v: "at a keyboard with a live connection", g: "major" }, { v: "handed a bow", g: "crippling" }] },
      { n: "Thea Queen", t: 3, f: 3, s: "Arrow Speedy", wiki: "arrow" },
      { n: "Malcolm Merlyn", t: 4, f: 4, s: "Arrow Dark Archer", wiki: "arrow", variants: [{ v: "the Undertaking already underway", g: "major" }, { v: "the hand is off", g: "weakening" }] },
      ...
      { n: "Sara Lance", t: 4, f: 4, s: "White Canary Legends of Tomorrow", wiki: "arrow", variants: [{ v: "League training and no leash", g: "major" }, { v: "back from the Pit without her soul", g: "weakening" }] },
      { n: "Roy Harper", t: 3, f: 2, s: "Arsenal CW", wiki: "arrow" },

      { n: "Alex Danvers", t: 2, f: 3, wiki: "arrow" },
      { n: "Lena Luthor", t: 2, f: 3, wiki: "arrow" },
      { n: "Reign", t: 5, f: 2, s: "Supergirl Reign Worldkiller", wiki: "arrow", variants: [{ v: "fully awakened Worldkiller", g: "legendary" }, { v: "still Sam, on a work shift", g: "crippling" }] },
      ...
      { n: "Firestorm", t: 4, f: 3, s: "Legends of Tomorrow Firestorm", wiki: "arrow", variants: [{ v: "both halves agreeing", g: "major" }, { v: "both halves arguing", g: "crippling" }] },
      { n: "Hawkman", t: 3, f: 2, s: "Legends of Tomorrow Hawkman", wiki: "arrow" },
      { n: "Hawkgirl", t: 3, f: 2, s: "Legends of Tomorrow Hawkgirl", wiki: "arrow" },
      { n: "Vandal Savage", t: 4, f: 3, wiki: "arrow", variants: [{ v: "fifty thousand years of practice", g: "legendary" }, { v: "somebody else is holding the dagger", g: "crippling" }] },
      ...
      { n: "Alice", t: 2, f: 2, s: "Batwoman Alice Beth Kane", wiki: "arrow", variants: [{ v: "she has planned every single part of this", g: "major" }, { v: "she wants her sister to say the name", g: "weakening" }] },
      ...
      { n: "Archie Andrews", t: 1, f: 3, s: "Riverdale Archie", wiki: "riverdale", variants: [{ v: "somehow, inexplicably, boxing a bear", g: "major" }, { v: "singing about it", g: "crippling" }] },
      { n: "Jughead Jones", t: 1, f: 2, s: "Riverdale Jughead", wiki: "riverdale", variants: [{ v: "he has been fed", g: "boon" }, { v: "narrating instead of helping", g: "crippling" }] },
      { n: "Betty Cooper", t: 1, f: 2, s: "Riverdale Betty", wiki: "riverdale" },
      { n: "Cheryl Blossom", t: 1, f: 2, s: "Riverdale Cheryl", wiki: "riverdale", variants: [{ v: "the bow, and total commitment", g: "major" }, { v: "the family name has finally caught up", g: "weakening" }] },
  ...
  // ── Supernatural ──────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      { n: "Raphael", t: 4, f: 2, variants: [{ v: "archangel, and done negotiating", g: "legendary" }, { v: "in a vessel about to burn out", g: "crippling" }] },
      ...
      { n: "Abaddon", t: 4, f: 3, s: "Supernatural Abaddon Knight of Hell", variants: [{ v: "a Knight of Hell with an army behind her", g: "legendary" }, { v: "the demon bomb is already inside her", g: "crippling" }] },
      { n: "Cain", t: 5, f: 2, s: "Supernatural Cain Father of Murder", variants: [
        { v: "with the First Blade", g: "legendary" },
      ] },
      { n: "Alastair", t: 4, f: 2, variants: [{ v: "all of the tools already laid out", g: "major" }, { v: "in a trap ringed with holy fire", g: "crippling" }] },
      { n: "Azazel", t: 4, f: 3, s: "Supernatural Azazel yellow eyed demon", variants: [{ v: "yellow eyes, and the Colt is somewhere else", g: "major" }, { v: "the Colt is right here", g: "crippling" }] },
      { n: "Lilith", t: 4, f: 3, variants: [{ v: "the first demon, breaking a seal", g: "legendary" }, { v: "she is the final seal", g: "crippling" }] },
      { n: "Metatron", t: 4, f: 2, variants: [{ v: "with the angel tablet", g: "legendary" }] },
      { n: "Eve", t: 4, f: 2, s: "Supernatural Eve Mother of All", variants: [{ v: "the Mother of All, making something new", g: "legendary" }, { v: "phoenix ash", g: "crippling" }] },
      { n: "Dick Roman", t: 4, f: 3, s: "Supernatural Dick Roman Leviathan", variants: [{ v: "a Leviathan running a corporation", g: "major" }, { v: "borax", g: "crippling" }] },
      { n: "Zachariah", t: 3, f: 2, variants: [{ v: "he has already rearranged the room", g: "major" }, { v: "a banishing sigil drawn in blood", g: "crippling" }] },
      { n: "Naomi", t: 3, f: 2, variants: [{ v: "the whole of Heaven's bureaucracy behind her", g: "major" }, { v: "the drill has been taken off her", g: "crippling" }] },
      { n: "Gadreel", t: 3, f: 2, variants: [{ v: "riding a vessel that trusts him", g: "major" }, { v: "known for what he let in", g: "weakening" }] },
      { n: "Balthazar", t: 3, f: 2 },
      { n: "Anna Milton", t: 3, f: 2 },
      { n: "Uriel", t: 3, f: 2 },
      { n: "Meg Masters", t: 3, f: 4, variants: [{ v: "riding somebody the boys trust", g: "major" }, { v: "in a psychiatric ward, playing along", g: "weakening" }] },
      ...
      { n: "Bobby Singer", t: 2, f: 5, variants: [
        ...
        { v: "the panic room, salted and iron-lined", g: "boon" },
      ] },
      ...
      { n: "Benny Lafitte", t: 3, f: 2, variants: [{ v: "straight out of Purgatory, at full", g: "major" }, { v: "a vampire trying very hard not to be", g: "weakening" }] },
      { n: "Arthur Ketch", t: 3, f: 2, variants: [{ v: "the whole British Men of Letters kit", g: "major" }, { v: "he has changed sides again", g: "weakening" }] },
      { n: "Garth Fitzgerald", t: 2, f: 2, variants: [{ v: "a werewolf, and fine about it", g: "major" }] },
      { n: "Jody Mills", t: 2, f: 3, variants: [{ v: "a sheriff's shotgun and no illusions left", g: "boon" }, { v: "off duty, and out of range", g: "weakening" }] },
      { n: "Donna Hanscum", t: 2, f: 2 },
      { n: "Charlie Bradbury", t: 1, f: 3, variants: [{ v: "three days and a laptop", g: "major" }, { v: "she has been sent to Oz", g: "neutral" }] },
      ...
      { n: "A hellhound", t: 3, f: 3, s: "Supernatural hellhound", variants: [{ v: "nobody here has holy fire or the sight", g: "major" }, { v: "somebody is wearing the glasses", g: "crippling" }] },
      { n: "A Leviathan", t: 4, f: 2, s: "Supernatural Leviathan", variants: [{ v: "nobody has worked out what borax does yet", g: "major" }, { v: "decapitated, head kept in another state", g: "crippling" }] },
      { n: "A wendigo", t: 2, f: 2, s: "Supernatural wendigo", variants: [{ v: "the fire has gone out", g: "major" }, { v: "somebody has a flare gun", g: "crippling" }] },
      { n: "A rugaru", t: 2, f: 1, s: "Supernatural rugaru" },
      { n: "The Impala", t: 2, f: 4, s: "Supernatural Impala 1967 Chevrolet", variants: [{ v: "Baby, with the trunk open", g: "legendary" }, { v: "up on blocks", g: "crippling" }] },
    ],
  },
