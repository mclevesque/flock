...
class Clairvoyance {
    constructor(engine) {
        ...
        this.profiles = {
            ...
            social_deduction: {
                name: 'Social Deduction (Among Us/Mafia/WHO DONE IT?)',
                screenCrossTime: { min: 4.0, ideal: 6.0, max: 10.0 },
                moveSpeed8Dir: true,
                accelTime: { min: 0.0, ideal: 0.05, max: 0.15 },
                nightDuration: { min: 3, ideal: 5, max: 10 },         // seconds
                discussDuration: { min: 10, ideal: 15, max: 30 },
                voteDuration: { min: 5, ideal: 10, max: 20 },
                minPlayers: 4, maxPlayers: 15,
                murdererVisionMultiple: { min: 2, ideal: 3.5, max: 5 }, // vs innocent
                killCooldown: { min: 1.0, ideal: 2.0, max: 5.0 },
                npcVoteAccuracy: { min: 0.15, ideal: 0.3, max: 0.5 },  // chance to ID murderer
            }
        };
